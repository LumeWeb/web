import { core_dashboard__loadShare__react__loadShare__, React, jsxRuntimeExports } from './jsx-runtime-D_0QkpWj.js';
...
import { UploadStatus, isFolderBundle, FileStatus } from './upload-Dami3hzH.js';
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
          ...
          !hideStatusIndicators && fileStatus !== FileStatus.PENDING && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs", children: [
              ...
              fileStatus !== FileStatus.COMPLETE && file.progress?.percentage !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                Math.round(file.progress.percentage),
                "%"
              ] })
            ] }),
            fileStatus !== FileStatus.COMPLETE && file.progress?.percentage !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function DropzoneContent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(core_dashboard__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__.Card, { className: "border-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(core_dashboard__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__.CardContent, { className: "space-y-4", children: [
    showDropZone && (renderDropZone ? renderDropZone(isDragOver, handleFileButtonClick, handleDirectoryButtonClick, {
      containerRef,
      directoryInputRef,
      disabled,
      dragLeaveClassName,
...
export { Check, Dropzone, FileText, Folder, Upload, UploadProgress, filesize };
