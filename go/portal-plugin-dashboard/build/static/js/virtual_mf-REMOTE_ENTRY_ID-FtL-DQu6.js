...
import exposesMap from './virtualExposes-BSkqVj7Q.js';
...
const importMap = {
        ...
        "@lumeweb/portal-framework-core": async () => {
          let pkg = await import('./index-Cpmt77FN.js');
          return pkg
        }
      ,
        "@lumeweb/portal-framework-ui": async () => {
          let pkg = await import('./index-B_WQpdKp.js');
          return pkg
        }
      ,
        "@refinedev/core": async () => {
          let pkg = await import('./index-WNwA9FXn.js');
          return pkg
        }
      ,
      ...
      ,
        "react-hook-form": async () => {
          let pkg = await import('./index.esm-C1CNQHLY.js');
          return pkg
        }
      ,
        "@lumeweb/portal-framework-ui-core": async () => {
          let pkg = await import('./index-BiEttStI.js');
          return pkg
        }
      ,
        "react-dom": async () => {
          let pkg = await import('./index-D0terACP.js').then(n => n.index);
          return pkg
        }
