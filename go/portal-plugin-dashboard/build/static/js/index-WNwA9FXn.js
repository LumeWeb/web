...
var b = {}, x = () => b, C = define_process_env_default$1.NODE_ENV !== "development" ? x : (r) => {
  let { ws: e } = core_dashboard__loadShare__react__loadShare__.useContext(p$1), n = React.useRef(), o = React.useRef();
