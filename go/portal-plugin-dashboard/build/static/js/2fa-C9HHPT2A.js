import { core_dashboard__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__, React, jsxRuntimeExports, core_dashboard__loadShare__react__loadShare__ } from './core_dashboard__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__-D-EDec9Y.js';
...
const schema = object({
  password: string().min(1, "Password cannot be empty").refine((val) => val.trim().length > 0, {
    ...
    steps: [
      ...
      },
      {
        ...
        validationSchema: object({
          otp: string().min(6, "OTP must be at least 6 characters")
        })
      }
    ]
  };
