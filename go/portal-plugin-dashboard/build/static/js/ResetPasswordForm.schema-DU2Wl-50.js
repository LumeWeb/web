...
import { z, anyType, ZodArray, ZodObject, ZodEffects, ZodOptional, ZodCatch, ZodIntersection, ZodUnion, ZodDiscriminatedUnion, ZodBranded, ZodTuple, ZodNullable, ZodPipeline, lazyType } from './index-BxxS_31b.js';
import { createLucideIcon } from './createLucideIcon-DUJfluEp.js';
import { core_dashboard__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__, Ellipsis, lumeBgLoginPng, discordLogoPng, lumeColorLogoPng, createFormContext as createFormContext$1, isPrefix, formatPaths, getPaths, INTENT, parse, lumeBgRegisterPng, lumeBgPng } from './form-D1oJQ5Wn.js';
import { Search } from './search-DtKVOMxG.js';
...
const LoginForm = () => {
	...
	return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxRuntimeExports.jsx(core_dashboard__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.SchemaForm, { config: formConfig }), /* @__PURE__ */ jsxRuntimeExports.jsxs("p", {
			...
			children: [
				...
				/* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxRuntimeExports.jsx("img", {
						...
						}), /* @__PURE__ */ jsxRuntimeExports.jsx(core_dashboard__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.InlineAuthLinkBanner, {
							label: "New user?",
						...
						children: [
							...
							/* @__PURE__ */ jsxRuntimeExports.jsx("footer", {
								...
								children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", {
									...
									children: [/* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(core_dashboard__loadShare__react_mf_2_router__loadShare__.Link, {
									...
									}) }), /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(core_dashboard__loadShare__react_mf_2_router__loadShare__.Link, {
...
function useFormState(form, subjectRef) {
  var subscribe = core_dashboard__loadShare__react__loadShare__.useCallback(callback => form.subscribe(callback, () => subjectRef === null || subjectRef === void 0 ? void 0 : subjectRef.current), [form, subjectRef]);
  return core_dashboard__loadShare__react__loadShare__.useSyncExternalStore(subscribe, form.getState, form.getState);
}
function useSubjectRef() {
  var initialSubject = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var subjectRef = core_dashboard__loadShare__react__loadShare__.useRef(initialSubject);
 ...
 */
var useSafeLayoutEffect = typeof document === 'undefined' ? core_dashboard__loadShare__react__loadShare__.useEffect : core_dashboard__loadShare__react__loadShare__.useLayoutEffect;
function useFormId(preferredId) {
  var id = core_dashboard__loadShare__react__loadShare__.useId();
...
function useNoValidate() {
  ...
  var [noValidate, setNoValidate] = core_dashboard__loadShare__react__loadShare__.useState(defaultNoValidate);
  useSafeLayoutEffect(() => {
...
function useForm(options) {
  ...
  var [context] = core_dashboard__loadShare__react__loadShare__.useState(() => createFormContext(_objectSpread2$1(_objectSpread2$1({}, formConfig), {}, {
    formId
  })));
  useSafeLayoutEffect(() => {
					...
					/* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxRuntimeExports.jsx(core_dashboard__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.Field, {
									className: "flex-1",
									errors: fields.firstName.errors,
									inputProps: { name: fields.firstName.name },
									labelProps: { children: "First Name" }
								}), /* @__PURE__ */ jsxRuntimeExports.jsx(core_dashboard__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.Field, {
									className: "flex-1",
							...
							/* @__PURE__ */ jsxRuntimeExports.jsx(core_dashboard__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.FieldCheckbox, {
...
var ResetPasswordConfirmForm_schema_default = schema$1;
...
var ResetPasswordForm_schema_default = schema;

export { AuthedIndex_default, LoginIndex_default, RegisterIndex_default, ResetPasswordConfirmForm_schema_default, ResetPasswordForm_schema_default, ResetPasswordLayout_default };
