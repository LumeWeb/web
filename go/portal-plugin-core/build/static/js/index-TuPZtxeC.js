...
var useMediaQuery = /* @__PURE__ */ __name((query) => {
  const [matches, setMatches] = core_core__loadShare__react__loadShare__.useState(false);
...
var useMutationMode = /* @__PURE__ */ __name((preferredMutationMode, preferredUndoableTimeout) => {
  const { mutationMode, undoableTimeout } = core_core__loadShare__react__loadShare__.useContext(RefineContext);
  return {
...
var UnsavedWarnContextProvider = /* @__PURE__ */ __name(({
  ...
  const [warnWhen, setWarnWhen] = core_core__loadShare__react__loadShare__.useState(false);
...
var useWarnAboutChange = /* @__PURE__ */ __name(() => {
  const { warnWhenUnsavedChanges } = core_core__loadShare__react__loadShare__.useContext(RefineContext);
  const { warnWhen, setWarnWhen } = core_core__loadShare__react__loadShare__.useContext(UnsavedWarnContext);
  return {
    warnWhenUnsavedChanges,
...
var useSyncWithLocation = /* @__PURE__ */ __name(() => {
  const { syncWithLocation } = core_core__loadShare__react__loadShare__.useContext(RefineContext);
  return { syncWithLocation };
}, "useSyncWithLocation");
var useTitle = /* @__PURE__ */ __name(() => {
  const { Title } = core_core__loadShare__react__loadShare__.useContext(RefineContext);
  return Title;
}, "useTitle");
var useRefineContext = /* @__PURE__ */ __name(() => {
  const {
    ...
    options,
    __initialized
  } = core_core__loadShare__react__loadShare__.useContext(RefineContext);
  return {
    __initialized,
    Footer,
    Header,
...
function usePermissions({
  ...
  const queryResponse = core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQuery({
  ...
  const legacyQueryResponse = core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQuery({
    queryKey: [
...
var useInvalidateAuthStore = /* @__PURE__ */ __name(() => {
  const queryClient = core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQueryClient();
  const { keys: keys2, preferLegacyKeys } = useKeys();
...
function useLogout({
  ...
  const { keys: keys2, preferLegacyKeys } = useKeys();
  const mutation = core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({
  ...
  const v3LegacyAuthProviderCompatibleMutation = core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({
    mutationKey: [
...
var useLoadingOvertime = /* @__PURE__ */ __name(({
  ...
  const [elapsedTime, setElapsedTime] = core_core__loadShare__react__loadShare__.useState(void 0);
...
var useUpdate = /* @__PURE__ */ __name(({
  ...
  const { keys: keys2, preferLegacyKeys } = useKeys();
  const mutationResult = core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({
    mutationFn: ({
      id = idFromProps,
      values = valuesFromProps,
...
var useDataProvider = /* @__PURE__ */ __name(() => {
  const context = core_core__loadShare__react__loadShare__.useContext(DataContext);
  const handleDataProvider = core_core__loadShare__react__loadShare__.useCallback(
    (dataProviderName) => {
      if (dataProviderName) {
...
var useInfiniteList = /* @__PURE__ */ __name(({
  ...
  const queryResponse = core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useInfiniteQuery({
...
var useInvalidate = /* @__PURE__ */ __name(() => {
  ...
  const queryClient = core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQueryClient();
  const { keys: keys2, preferLegacyKeys } = useKeys();
  const invalidate = core_core__loadShare__react__loadShare__.useCallback(
    async ({
      resource,
      dataProviderName,
      invalidates,
...
var useMemoized = /* @__PURE__ */ __name((value) => {
  const ref = core_core__loadShare__react__loadShare__.useRef(value);
...
var useDeepMemo = /* @__PURE__ */ __name((fn, dependencies) => {
  ...
  const value = core_core__loadShare__react__loadShare__.useMemo(fn, memoizedDependencies);
  return value;
}, "useDeepMemo");
...
var RouterContext = core_core__loadShare__react__loadShare__.createContext(
...
var useParse = /* @__PURE__ */ __name(() => {
  const routerContext = core_core__loadShare__react__loadShare__.useContext(RouterContext);
...
function useResource(args) {
  const { resources } = core_core__loadShare__react__loadShare__.useContext(ResourceContext);
  const routerType = useRouterType();
...
var useResourceWithRoute = /* @__PURE__ */ __name(() => {
  const { resources } = core_core__loadShare__react__loadShare__.useContext(ResourceContext);
  const resourceWithRoute = core_core__loadShare__react__loadShare__.useCallback(
    (route) => {
...
var useResourceSubscription = /* @__PURE__ */ __name(({
  ...
  const { liveProvider } = core_core__loadShare__react__loadShare__.useContext(LiveContext);
  const {
...
var useLiveMode = /* @__PURE__ */ __name((liveMode) => {
  const { liveMode: liveModeFromContext } = core_core__loadShare__react__loadShare__.useContext(RefineContext);
...
var UndoableQueueContext = core_core__loadShare__react__loadShare__.createContext({
  notifications: [],
...
var UndoableQueueContextProvider = /* @__PURE__ */ __name(({
  ...
  const [notifications, notificationDispatch] = core_core__loadShare__react__loadShare__.useReducer(
    undoableQueueReducer,
    initialState
  );
...
var useCancelNotification = /* @__PURE__ */ __name(() => {
  const { notifications, notificationDispatch } = core_core__loadShare__react__loadShare__.useContext(UndoableQueueContext);
  return { notifications, notificationDispatch };
}, "useCancelNotification");
var NotificationContext = core_core__loadShare__react__loadShare__.createContext({});
...
var useNotification = /* @__PURE__ */ __name(() => {
  const { open, close } = core_core__loadShare__react__loadShare__.useContext(NotificationContext);
  return { open, close };
}, "useNotification");
var useHandleNotification = /* @__PURE__ */ __name(() => {
  const { open } = useNotification();
  const handleNotification = core_core__loadShare__react__loadShare__.useCallback(
...
var useSetLocale = /* @__PURE__ */ __name(() => {
  const { i18nProvider } = core_core__loadShare__react__loadShare__.useContext(I18nContext);
  return core_core__loadShare__react__loadShare__.useCallback((lang) => i18nProvider == null ? void 0 : i18nProvider.changeLocale(lang), []);
}, "useSetLocale");
var useTranslate = /* @__PURE__ */ __name(() => {
  const { i18nProvider } = core_core__loadShare__react__loadShare__.useContext(I18nContext);
  const fn = core_core__loadShare__react__loadShare__.useMemo(() => {
...
var useGetLocale = /* @__PURE__ */ __name(() => {
  const { i18nProvider } = core_core__loadShare__react__loadShare__.useContext(I18nContext);
  return core_core__loadShare__react__loadShare__.useCallback(() => i18nProvider == null ? void 0 : i18nProvider.getLocale(), []);
}, "useGetLocale");
...
var useExport = /* @__PURE__ */ __name(({
  ...
  const [isLoading, setIsLoading] = core_core__loadShare__react__loadShare__.useState(false);
  const dataProvider = useDataProvider();
  const getMeta = useMeta();
...
var useRedirectionAfterSubmission = /* @__PURE__ */ __name(() => {
  ...
  const handleSubmitWithRedirect = core_core__loadShare__react__loadShare__.useCallback(
    ({
      redirect,
      resource,
      id,
...
var useGo = /* @__PURE__ */ __name(() => {
  ...
  const go = core_core__loadShare__react__loadShare__.useCallback(
    (config) => {
...
var useImport = /* @__PURE__ */ __name(({
  ...
  const [processedAmount, setProcessedAmount] = core_core__loadShare__react__loadShare__.useState(0);
  const [totalAmount, setTotalAmount] = core_core__loadShare__react__loadShare__.useState(0);
  const [isLoading, setIsLoading] = core_core__loadShare__react__loadShare__.useState(false);
...
var useModal = /* @__PURE__ */ __name(({
  ...
  const [visible, setVisible] = core_core__loadShare__react__loadShare__.useState(defaultVisible);
  const show = core_core__loadShare__react__loadShare__.useCallback(() => setVisible(true), [visible]);
  const close = core_core__loadShare__react__loadShare__.useCallback(() => setVisible(false), [visible]);
  return {
    visible,
    show,
    close
...
var Link = core_core__loadShare__react__loadShare__.forwardRef(LinkComponent);
...
var useRouterContext = /* @__PURE__ */ __name(() => {
  const routerContextValues = core_core__loadShare__react__loadShare__.useContext(LegacyRouterContext);
...
var useCan = /* @__PURE__ */ __name(({
  ...
  const { can, options: globalOptions } = core_core__loadShare__react__loadShare__.useContext(AccessControlContext);
  const { keys: keys2, preferLegacyKeys } = useKeys();
...
var useSelect = /* @__PURE__ */ __name((props) => {
  const [search, setSearch] = core_core__loadShare__react__loadShare__.useState([]);
  const [options, setOptions] = core_core__loadShare__react__loadShare__.useState([]);
  const [selectedOptions, setSelectedOptions] = core_core__loadShare__react__loadShare__.useState([]);
  const {
    resource: resourceFromProps,
    sort,
    sorters,
  ...
  const getOptionLabel = core_core__loadShare__react__loadShare__.useCallback(
    (item) => {
  ...
  const getOptionValue = core_core__loadShare__react__loadShare__.useCallback(
    (item) => {
  ...
  const defaultValueQueryOnSuccess = core_core__loadShare__react__loadShare__.useCallback(
    (data) => {
      setSelectedOptions(
        data.data.map(
          (item) => ({
  ...
  const defaultQueryOnSuccess = core_core__loadShare__react__loadShare__.useCallback(
    (data) => {
      setOptions(
        data.data.map(
          (item) => ({
  ...
  const combinedOptions = core_core__loadShare__react__loadShare__.useMemo(
    () => uniqBy(
  ...
  const onSearchFromPropRef = core_core__loadShare__react__loadShare__.useRef(onSearchFromProp);
  const onSearch = core_core__loadShare__react__loadShare__.useMemo(() => {
...
function useTable({
  ...
  const [sorters, setSorters] = core_core__loadShare__react__loadShare__.useState(
    setInitialSorters(preferredPermanentSorters, defaultSorter ?? [])
  );
  const [filters, setFilters] = core_core__loadShare__react__loadShare__.useState(
    setInitialFilters(preferredPermanentFilters, defaultFilter ?? [])
  );
  const [current, setCurrent] = core_core__loadShare__react__loadShare__.useState(defaultCurrent);
  const [pageSize, setPageSize] = core_core__loadShare__react__loadShare__.useState(defaultPageSize);
  ...
  const setFiltersAsMerge = core_core__loadShare__react__loadShare__.useCallback(
    (newFilters) => {
      setFilters(
  ...
  const setFiltersAsReplace = core_core__loadShare__react__loadShare__.useCallback(
    (newFilters) => {
      setFilters(unionFilters(preferredPermanentFilters, newFilters));
    },
    [preferredPermanentFilters]
  );
  const setFiltersWithSetter = core_core__loadShare__react__loadShare__.useCallback(
    (setter) => {
      setFilters(
  ...
  const setFiltersFn = core_core__loadShare__react__loadShare__.useCallback(
  ...
  const setSortWithUnion = core_core__loadShare__react__loadShare__.useCallback(
    (newSorter) => {
...
var useLog = /* @__PURE__ */ __name(({
  ...
  const queryClient = core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQueryClient();
  const auditLogContext = core_core__loadShare__react__loadShare__.useContext(AuditLogContext);
  const { keys: keys2, preferLegacyKeys } = useKeys();
  const authProvider = useActiveAuthProvider();
  const { resources } = core_core__loadShare__react__loadShare__.useContext(ResourceContext);
  const {
  ...
  const log = core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation(
    async (params) => {
      var _a, _b, _c, _d, _e;
  ...
  const rename = core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation(
    async (params) => {
      var _a;
...
var useLogList = /* @__PURE__ */ __name(({
  ...
  const { get: get2 } = core_core__loadShare__react__loadShare__.useContext(AuditLogContext);
  const { keys: keys2, preferLegacyKeys } = useKeys();
  const queryResponse = core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQuery({
...
var MetaContext = core_core__loadShare__react__loadShare__.createContext({});
var MetaContextProvider = /* @__PURE__ */ __name(({
  children,
  value
}) => {
  const currentValue = useMetaContext();
  const metaContext = core_core__loadShare__react__loadShare__.useMemo(() => {
    return {
      ...currentValue,
      ...value
    };
...
var useMetaContext = /* @__PURE__ */ __name(() => {
  const context = core_core__loadShare__react__loadShare__.useContext(MetaContext);
  if (!context) {
    throw new Error("useMetaContext must be used within a MetaContextProvider");
  }
  return core_core__loadShare__react__loadShare__.useContext(MetaContext);
}, "useMetaContext");
...
var ErrorComponent = /* @__PURE__ */ __name(() => {
  const [errorMessage, setErrorMessage] = core_core__loadShare__react__loadShare__.useState();
  const translate = useTranslate();
  const { push } = useNavigation();
  const go = useGo();
  const routerType = useRouterType();
...
var LoginPage = /* @__PURE__ */ __name(() => {
  const [username, setUsername] = core_core__loadShare__react__loadShare__.useState("");
  const [password, setPassword] = core_core__loadShare__react__loadShare__.useState("");
  const translate = useTranslate();
  const authProvider = useActiveAuthProvider();
...
var LoginPage2 = /* @__PURE__ */ __name(({
  ...
  const [email, setEmail] = core_core__loadShare__react__loadShare__.useState("");
  const [password, setPassword] = core_core__loadShare__react__loadShare__.useState("");
  const [remember, setRemember] = core_core__loadShare__react__loadShare__.useState(false);
  const translate = useTranslate();
  const authProvider = useActiveAuthProvider();
  const { mutate: login } = useLogin({
    v3LegacyAuthProviderCompatible: Boolean(authProvider == null ? void 0 : authProvider.isLegacy)
...
var UpdatePasswordPage = /* @__PURE__ */ __name(({
  ...
  const [newPassword, setNewPassword] = core_core__loadShare__react__loadShare__.useState("");
  const [confirmPassword, setConfirmPassword] = core_core__loadShare__react__loadShare__.useState("");
...
var Card = /* @__PURE__ */ __name(({ card }) => {
  ...
  const [isHover, setIsHover] = core_core__loadShare__react__loadShare__.useState(false);
  return /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
...
var useTelemetryData = /* @__PURE__ */ __name(() => {
  ...
  const auditLogContext = core_core__loadShare__react__loadShare__.useContext(AuditLogContext);
  const { liveProvider } = core_core__loadShare__react__loadShare__.useContext(LiveContext);
  const routerContext = core_core__loadShare__react__loadShare__.useContext(LegacyRouterContext);
  const dataContext = core_core__loadShare__react__loadShare__.useContext(DataContext);
  const { i18nProvider } = core_core__loadShare__react__loadShare__.useContext(I18nContext);
  const notificationContext = core_core__loadShare__react__loadShare__.useContext(NotificationContext);
  const accessControlContext = core_core__loadShare__react__loadShare__.useContext(AccessControlContext);
  const { resources } = useResource();
...
var Refine = /* @__PURE__ */ __name(({
  ...
  const queryClient = useDeepMemo(() => {
    var _a;
    if (reactQueryWithDefaults.clientConfig instanceof core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.QueryClient) {
      return reactQueryWithDefaults.clientConfig;
    }
    return new core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.QueryClient({
  ...
  return /* @__PURE__ */ React.createElement(core_core__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React.createElement(NotificationContextProvider, { ...notificationProviderContextValues }, /* @__PURE__ */ React.createElement(
    LegacyAuthContextProvider,
    {
      ...legacyAuthProvider ?? {},
...
var UndoableQueue = /* @__PURE__ */ __name(({ notification }) => {
  ...
  const { notificationDispatch } = useCancelNotification();
  const { open } = useNotification();
  const [timeoutId, setTimeoutId] = core_core__loadShare__react__loadShare__.useState();
