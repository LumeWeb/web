...
function convertRoutesToDataRoutes(routes, mapRouteProperties2, parentPath, manifest) {
  ...
  return routes.map((route, index) => {
    ...
    if (isIndexRoute(route)) {
      let indexRoute = _extends$1({}, route, mapRouteProperties2(route), {
        id
      });
      manifest[id] = indexRoute;
      return indexRoute;
    } else {
      let pathOrLayoutRoute = _extends$1({}, route, mapRouteProperties2(route), {
        id,
        children: void 0
      });
...
async function loadLazyRouteModule(route, mapRouteProperties2, manifest) {
  ...
  Object.assign(routeToUpdate, _extends$1({}, mapRouteProperties2(routeToUpdate), {
    lazy: void 0
  }));
}
...
export {
  ...
  DataRouterContext as j,
  DataRouterStateContext as k,
  useAsyncError as l,
  matchRoutes as m,
  Await as n,
  useRoutesImpl as o,
  parsePath as p,
  NavigationContext as q,
  redirect as r,
  stripBasename as s,
  useResolvedPath as t,
  useLocation as u,
  createPath as v,
  useRouteId as w,
  RouteContext as x,
