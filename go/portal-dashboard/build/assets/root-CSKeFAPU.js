...
import { G, i as it, K as Ko, B as Buffer, Q as QueryClient, a as QueryClientProvider, _ as _u } from "./index-DajgEckg.js";
...
import { T as ToastProvider, a as Toast, b as ToastTitle, c as ToastDescription, d as ToastClose, e as ToastViewport, f as ToastAction } from "./toast-0-e1CPH4.js";
import { c as customInstance, P as PROTOCOL_S5, a as createProtocol, S as S5, M as Multihash, C as CID, b as CID_TYPES, U as Unpacker, m as metadataMagicByte, d as METADATA_TYPES, e as PinningProcess } from "./pinning-Cfl__oC0.js";
...
const stylesheet = "/assets/tailwind-D73RDMw_.css";
var g = (e, r) => {
...
var x = { addQueryPrefix: true, skipNulls: true, arrayFormat: "indices", encode: false, encodeValuesOnly: true }, E = { go: () => {
  ...
  let e = useParams(), { pathname: r, search: t } = useLocation(), { resources: a } = reactExports.useContext(it), { resource: n, action: o, matchedRoute: u } = React.useMemo(() => Ko(r, a), [a, r]), i = u && r ? g(r, u) : {}, s = i.id;
