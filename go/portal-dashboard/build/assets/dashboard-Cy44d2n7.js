import { j as jsxRuntimeExports, k as getDefaultExportFromCjs, R as React, r as reactExports, l as getAugmentedNamespace } from "./index-BIsqO_uY.js";
import { C as CrownIcon, P as PersonIcon, w as CloudIcon, x as CloudDownloadIcon, y as CheckRoundedIcon, A as AddIcon, _ as _baseGetTag, z as isObject_1, B as _root, E as debounce_1, H as debounce, I as InfoIcon, G as GeneralLayout, J as CloudUploadSolidIcon } from "./general-layout-pdk0TKoB.js";
import { H as Hr, J as Ju } from "./index-Cb6cVh9L.js";
import { A as Avatar, U as UsageCard } from "./usage-card-Dxh5YLgv.js";
...
import "./pinning-BsL2ituL.js";
import "./sdk-context-tsvDc9Pk.js";
import "./forms-uCsZ1COU.js";
import "./components-C01XGMk1.js";
const UpgradeAccountBanner = () => {
  const { data: identity2 } = Hr();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-8 border border-ring rounded-lg bg-secondary-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-x-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-x-5 mt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-x-2 text-white text-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "gap-x-2 py-6", variant: "accent", children: [
...
Mexp$4.math = {
  ...
  cos: function(x2) {
    if (Mexp$4.math.isDegree)
      x2 = Mexp$4.math.toRadian(x2);
    return Math.cos(x2);
  },
  cosh: function(x2) {
...
function getXAndYFromEvent(event) {
  if (!event)
    return _extends$Q({}, DEFAULT_POINT);
...
function localPoint(nodeOrEvent, maybeEvent) {
  ...
  if (isEvent(nodeOrEvent)) {
    ...
    if (node)
      return localPoint$1(node, event);
  }
  return null;
}
var src$8 = {};
...
var bisector$2 = {};
var descending$3 = {};
Object.defineProperty(descending$3, "__esModule", {
  value: true
});
descending$3.default = descending$2;
...
var _descending = _interopRequireDefault$R(descending$3);
...
var cross$2 = {};
Object.defineProperty(cross$2, "__esModule", {
  value: true
});
cross$2.default = cross$1;
...
src$6.InternSet = src$6.InternMap = void 0;
...
var identity$7 = {};
Object.defineProperty(identity$7, "__esModule", {
  value: true
});
identity$7.default = identity$6;
...
var _index$q = src$6;
var _identity$2 = _interopRequireDefault$O(identity$7);
...
function compareDefined(compare = _ascending$6.default) {
  if (compare === _ascending$6.default)
...
array$2.slice = slice$1;
var map$3 = array$1.map;
array$2.map = map$3;
var constant$5 = {};
Object.defineProperty(constant$5, "__esModule", {
  value: true
});
constant$5.default = constant$4;
...
function ticks$1(start2, stop2, count2) {
  ...
  if ((step2 = tickIncrement(start2, stop2, count2)) === 0 || !isFinite(step2))
    return [];
  if (step2 > 0) {
...
var _constant$3 = _interopRequireDefault$K(constant$5);
var _extent = _interopRequireDefault$K(extent$2);
var _identity$1 = _interopRequireDefault$K(identity$7);
...
function bin() {
  ...
  function histogram(data) {
    ...
    if (!Array.isArray(tz)) {
      const max2 = x1, tn = +tz;
      if (domain2 === _extent.default)
        [x0, x1] = (0, _nice$3.default)(x0, x1, tn);
      tz = (0, _ticks.default)(x0, x1, tn);
      if (tz[0] <= x0)
        step2 = (0, _ticks.tickIncrement)(x0, x1, tn);
...
var min$2 = {};
Object.defineProperty(min$2, "__esModule", {
  value: true
});
min$2.default = min$1;
...
var _max = _interopRequireDefault$I(max$2);
var _maxIndex$1 = _interopRequireDefault$I(maxIndex$1);
var _min$1 = _interopRequireDefault$I(min$2);
...
function quantile$2(values, p, valueof) {
  ...
  if (!(n = values.length) || isNaN(p = +p))
    return;
  if (p <= 0 || n < 2)
    return (0, _min$1.default)(values);
  if (p >= 1)
...
function quantileIndex(values, p, valueof) {
  ...
  if (!(n = values.length) || isNaN(p = +p))
    return;
  if (p <= 0 || n < 2)
    return (0, _minIndex$1.default)(values);
  if (p >= 1)
    return (0, _maxIndex$1.default)(values);
...
function rank(values, valueof = _ascending$3.default) {
  ...
  if (valueof.length !== 2)
    V = V.map(valueof), valueof = _ascending$3.default;
...
var sum$2 = {};
Object.defineProperty(sum$2, "__esModule", {
  value: true
});
sum$2.default = sum$1;
...
var _min = _interopRequireDefault$A(min$2);
...
(function(exports) {
  ...
  var _cross = _interopRequireDefault2(cross$2);
  var _cumsum = _interopRequireDefault2(cumsum$1);
  var _descending2 = _interopRequireDefault2(descending$3);
  ...
  var _max2 = _interopRequireDefault2(max$2);
  ...
  var _min2 = _interopRequireDefault2(min$2);
  ...
  var _sum = _interopRequireDefault2(sum$2);
...
(0, _define$2.default)(Color, color$1, {
  copy(channels) {
    return Object.assign(new this.constructor({details : {contentType : {name : {}}}}), this, channels);
  },
  displayable() {
...
function labConvert(o) {
  ...
  if (o instanceof Hcl)
    return hcl2lab(o);
  if (!(o instanceof _color$7.Rgb))
    o = (0, _color$7.rgbConvert)(o);
...
function cubehelixConvert(o) {
  ...
  if (!(o instanceof _color$6.Rgb))
    o = (0, _color$6.rgbConvert)(o);
...
var rgb$1 = {};
var basis$2 = {};
Object.defineProperty(basis$2, "__esModule", {
  value: true
});
basis$2.basis = basis$1;
basis$2.default = _default$A;
...
var basisClosed$1 = {};
Object.defineProperty(basisClosed$1, "__esModule", {
  value: true
});
basisClosed$1.default = _default$z;
var _basis$1 = basis$2;
...
var color = {};
var constant$3 = {};
Object.defineProperty(constant$3, "__esModule", {
  value: true
});
constant$3.default = void 0;
var _default$y = (x2) => () => x2;
constant$3.default = _default$y;
...
color.gamma = gamma;
color.hue = hue$1;
var _constant$2 = _interopRequireDefault$w(constant$3);
...
var _index$i = src$4;
var _basis = _interopRequireDefault$v(basis$2);
var _basisClosed = _interopRequireDefault$v(basisClosed$1);
...
function requireArray() {
  ...
  function genericArray(a2, b) {
    ...
    for (i = 0; i < na; ++i)
      x2[i] = (0, _value2.default)(a2[i], b[i]);
    for (; i < nb; ++i)
      c6[i] = b[i];
    return function(t) {
      for (i = 0; i < na; ++i)
...
function requireValue() {
  ...
  var _constant2 = _interopRequireDefault2(constant$3);
  var _numberArray = _interopRequireWildcard2(numberArray);
  function _getRequireWildcardCache2(nodeInterop) {
    if (typeof WeakMap !== "function")
      return null;
...
(function(exports) {
  ...
  var _basis2 = _interopRequireDefault2(basis$2);
  var _basisClosed2 = _interopRequireDefault2(basisClosed$1);
  var _date = _interopRequireDefault2(date$1);
...
continuous$1.identity = identity$3;
continuous$1.transformer = transformer$2;
var _index$d = src$7;
var _index2$4 = src$5;
var _constant$1 = _interopRequireDefault$q(constant$2);
...
function transformer$2() {
  var domain2 = unit, range2 = unit, interpolate2 = _index2$4.interpolate, transform2, untransform, unknown2, clamp2 = identity$3, piecewise2, output, input;
  function rescale() {
...
var identity$2 = {};
Object.defineProperty(identity$2, "__esModule", {
  value: true
});
identity$2.default = _default$b;
...
var _identity = _interopRequireDefault$o(identity$2);
function _interopRequireDefault$o(obj) {
  return obj && obj.__esModule ? obj : { default: obj };
}
...
function _default$a(locale2) {
  ...
  function newFormat(specifier) {
    ...
    if (zero2 || fill === "0" && align2 === "=")
      zero2 = true, fill = "0", align2 = "=";
    ...
    function format2(value2) {
      ...
      if (type === "c") {
        ...
        if (trim)
          value2 = (0, _formatTrim.default)(value2);
      ...
      if (comma && zero2)
        value2 = group2(padding2 + value2, padding2.length ? width - valueSuffix.length : Infinity), padding2 = "";
      switch (align2) {
        case "<":
...
function tickFormat(start2, stop2, count2, specifier) {
  ...
  switch (specifier.type) {
    case "s": {
      ...
      if (specifier.precision == null && !isNaN(precision = (0, _index2$3.precisionPrefix)(step2, value2)))
    ...
    case "p":
    case "r": {
      if (specifier.precision == null && !isNaN(precision = (0, _index2$3.precisionRound)(step2, Math.max(Math.abs(start2), Math.abs(stop2)))))
        specifier.precision = precision - (specifier.type === "e");
      break;
    }
    case "f":
    case "%": {
      if (specifier.precision == null && !isNaN(precision = (0, _index2$3.precisionFixed)(step2)))
...
function identity$1(domain2) {
  ...
  scale.copy = function() {
    return identity$1(domain2).unknown(unknown2);
  };
...
function loggish(transform2) {
  ...
  scale.tickFormat = (count2, specifier) => {
    ...
    if (typeof specifier !== "function") {
      if (!(base2 % 1) && (specifier = (0, _index2$2.formatSpecifier)(specifier)).precision == null)
        specifier.trim = true;
...
function radial() {
  ...
  scale.range = function(_) {
    return arguments.length ? (squared.range((range2 = Array.from(_, _number.default)).map(square$1)), scale) : range2.slice();
  };
  scale.rangeRound = function(_) {
...
function quantile() {
  ...
  function rescale() {
    ...
    while (++i < n)
      thresholds[i - 1] = (0, _index$9.quantileSorted)(domain2, i / n);
    return scale;
  }
  function scale(x2) {
...
function ticker(year2, month2, week2, day2, hour2, minute2) {
  ...
  function tickInterval(start2, stop2, count2) {
    ...
    if (i === tickIntervals.length)
      return year2.every((0, _index$6.tickStep)(start2 / _duration.durationYear, stop2 / _duration.durationYear, count2));
    if (i === 0)
      return _millisecond.millisecond.every(Math.max((0, _index$6.tickStep)(start2, stop2, count2), 1));
...
function sequentialQuantile() {
  ...
  function scale(x2) {
    if (x2 != null && !isNaN(x2 = +x2))
      return interpolator(((0, _index$1.bisect)(domain2, x2, 1) - 1) / (domain2.length - 1));
  }
  scale.domain = function(_) {
    if (!arguments.length)
      return domain2.slice();
...
(function(exports) {
  ...
  var _identity2 = _interopRequireDefault2(identity$5);
...
const DataContext$1 = DataContext;
...
function d3Line() {
  var x$1 = x, y$1 = y, defined = constant$1(true), context = null, curve = curveLinear, output = null;
  function line2(data) {
...
function d3Pie() {
  var value2 = identity, sortValues = descending$1, sort2 = null, startAngle = constant$1(0), endAngle = constant$1(tau), padAngle = constant$1(0);
  function pie2(data) {
...
function d3stack() {
  ...
  stack2.keys = function(_) {
    return arguments.length ? (keys = typeof _ === "function" ? _ : constant$1(slice.call(_)), stack2) : keys;
  };
  ...
  stack2.order = function(_) {
    return arguments.length ? (order = _ == null ? stackOrderNone : typeof _ === "function" ? _ : constant$1(slice.call(_)), stack2) : order;
  };
...
function arc$1(_temp) {
  ...
  var path2 = d3Arc();
  if (innerRadius != null)
    setNumberOrNumberAccessor$2(path2.innerRadius, innerRadius);
  if (outerRadius != null)
    setNumberOrNumberAccessor$2(path2.outerRadius, outerRadius);
  if (cornerRadius != null)
    setNumberOrNumberAccessor$2(path2.cornerRadius, cornerRadius);
  if (startAngle != null)
    setNumberOrNumberAccessor$2(path2.startAngle, startAngle);
  if (endAngle != null)
    setNumberOrNumberAccessor$2(path2.endAngle, endAngle);
  if (padAngle != null)
    setNumberOrNumberAccessor$2(path2.padAngle, padAngle);
  if (padRadius != null)
    setNumberOrNumberAccessor$2(path2.padRadius, padRadius);
  return path2;
}
function area$1(_temp2) {
  ...
  var path2 = d3Area();
  if (x2)
    setNumberOrNumberAccessor$2(path2.x, x2);
  if (x0)
    setNumberOrNumberAccessor$2(path2.x0, x0);
  if (x1)
    setNumberOrNumberAccessor$2(path2.x1, x1);
  if (y2)
    setNumberOrNumberAccessor$2(path2.y, y2);
  if (y0)
    setNumberOrNumberAccessor$2(path2.y0, y0);
  if (y1)
    setNumberOrNumberAccessor$2(path2.y1, y1);
  if (defined)
...
function radialLine$1(_temp5) {
  ...
  if (angle)
    setNumberOrNumberAccessor$2(path2.angle, angle);
  if (radius)
    setNumberOrNumberAccessor$2(path2.radius, radius);
  if (defined)
    path2.defined(defined);
  if (curve)
    path2.curve(curve);
...
function stack$1(_ref6) {
  ...
  if (keys)
    path2.keys(keys);
  if (value2)
    setNumberOrNumberAccessor$2(path2.value, value2);
  if (order)
    path2.order(stackOrder$2(order));
  if (offset)
    path2.offset(stackOffset$2(offset));
  return path2;
}
...
function AreaClosed(_ref) {
  ...
  if (y2 && !y1)
    setNumberOrNumberAccessor$2(path2.y1, y2);
  if (y1 && !y2)
    setNumberOrNumberAccessor$2(path2.y1, y1);
  if (children)
    return /* @__PURE__ */ React.createElement(React.Fragment, null, children({
...
function BarGroup(_ref) {
  ...
  if (children)
    return /* @__PURE__ */ React.createElement(React.Fragment, null, children(barGroups));
  return /* @__PURE__ */ React.createElement(Group, {
...
function BarStack(_ref) {
  ...
  if (keys)
    stack2.keys(keys);
  if (value2)
    setNumberOrNumberAccessor$2(stack2.value, value2);
  if (order)
    stack2.order(stackOrder$2(order));
  if (offset)
  ...
  if (children)
    return /* @__PURE__ */ React.createElement(React.Fragment, null, children(barStacks));
  return /* @__PURE__ */ React.createElement(Group, {
...
(function(module) {
  ...
  var W = (t, e) => {
    ...
    if (e && typeof e == "object" || typeof e == "function")
      for (let s2 of j(e))
        !R.call(t, s2) && s2 !== o && v(t, s2, { get: () => e[s2], enumerable: !(i = T(e, s2)) || i.enumerable });
    return t;
...
function BaseAxis(_ref) {
  ...
  var _useContext = reactExports.useContext(DataContext$1), theme = _useContext.theme, xScale = _useContext.xScale, yScale = _useContext.yScale, margin = _useContext.margin, width = _useContext.width, height = _useContext.height;
...
const TooltipContext$1 = TooltipContext;
var useParentSize$1 = {};
...
function useParentSize(_temp) {
  ...
  (0, _react$2.useEffect)(function() {
    ...
    if (parentRef.current)
      observer2.observe(parentRef.current);
    return function() {
...
const EventEmitterContext$1 = EventEmitterContext;
function useEventEmitter(eventType, handler, allowedSources) {
  var emitter = reactExports.useContext(EventEmitterContext$1);
...
function EventEmitterProvider(_ref) {
  ...
  return /* @__PURE__ */ React.createElement(EventEmitterContext$1.Provider, {
    value: emitter
  }, children);
}
function _extends$a() {
...
function TooltipProvider(_ref) {
  ...
  return /* @__PURE__ */ React.createElement(TooltipContext$1.Provider, {
    value: value2
  }, children);
}
...
function DataProvider(_ref) {
  ...
  var contextTheme = reactExports.useContext(ThemeContext$1);
...
function usePointerEventHandlers(_ref) {
  ...
  var _ref2 = reactExports.useContext(DataContext$1), width = _ref2.width, height = _ref2.height, horizontal = _ref2.horizontal, dataRegistry = _ref2.dataRegistry, xScale = _ref2.xScale, yScale = _ref2.yScale;
...
function XYChart(props) {
  ...
  var _useContext = reactExports.useContext(DataContext$1), setDimensions = _useContext.setDimensions, resizeObserverPolyfill = _useContext.resizeObserverPolyfill;
  var tooltipContext = reactExports.useContext(TooltipContext$1);
  var emit = useEventEmitter();
  reactExports.useEffect(function() {
...
function arc(_temp) {
  ...
  if (innerRadius != null)
    (0, _setNumberOrNumberAccessor.default)(path2.innerRadius, innerRadius);
  if (outerRadius != null)
    (0, _setNumberOrNumberAccessor.default)(path2.outerRadius, outerRadius);
  if (cornerRadius != null)
    (0, _setNumberOrNumberAccessor.default)(path2.cornerRadius, cornerRadius);
  if (startAngle != null)
    (0, _setNumberOrNumberAccessor.default)(path2.startAngle, startAngle);
  if (endAngle != null)
    (0, _setNumberOrNumberAccessor.default)(path2.endAngle, endAngle);
  if (padAngle != null)
    (0, _setNumberOrNumberAccessor.default)(path2.padAngle, padAngle);
  if (padRadius != null)
    (0, _setNumberOrNumberAccessor.default)(path2.padRadius, padRadius);
  return path2;
}
function area(_temp2) {
  ...
  if (x2)
    (0, _setNumberOrNumberAccessor.default)(path2.x, x2);
  if (x0)
    (0, _setNumberOrNumberAccessor.default)(path2.x0, x0);
  if (x1)
    (0, _setNumberOrNumberAccessor.default)(path2.x1, x1);
  if (y2)
    (0, _setNumberOrNumberAccessor.default)(path2.y, y2);
  if (y0)
    (0, _setNumberOrNumberAccessor.default)(path2.y0, y0);
  if (y1)
    (0, _setNumberOrNumberAccessor.default)(path2.y1, y1);
  if (defined)
    path2.defined(defined);
  if (curve)
    path2.curve(curve);
...
function radialLine(_temp5) {
  ...
  if (angle)
    (0, _setNumberOrNumberAccessor.default)(path2.angle, angle);
  if (radius)
    (0, _setNumberOrNumberAccessor.default)(path2.radius, radius);
  if (defined)
    path2.defined(defined);
  if (curve)
    path2.curve(curve);
...
function stack(_ref6) {
  ...
  if (keys)
    path2.keys(keys);
  if (value2)
    (0, _setNumberOrNumberAccessor.default)(path2.value, value2);
  if (order)
    path2.order((0, _stackOrder.default)(order));
  if (offset)
    path2.offset((0, _stackOffset.default)(offset));
  return path2;
}
...
function withRegisteredData(BaseSeriesComponent) {
  function WrappedComponent(props) {
    ...
    var _ref = reactExports.useContext(DataContext$1), xScale = _ref.xScale, yScale = _ref.yScale, dataRegistry = _ref.dataRegistry;
    reactExports.useEffect(function() {
      if (dataRegistry)
...
function useSeriesEvents(_ref) {
  ...
  var _ref2 = (_useContext = reactExports.useContext(TooltipContext$1)) != null ? _useContext : {}, showTooltip = _ref2.showTooltip, hideTooltip = _ref2.hideTooltip;
...
function BaseGlyphSeries(_ref) {
  ...
  var _useContext = reactExports.useContext(DataContext$1), colorScale = _useContext.colorScale, theme = _useContext.theme, horizontal = _useContext.horizontal;
...
function BaseLineSeries(_ref) {
  ...
  var _useContext = reactExports.useContext(DataContext$1), colorScale = _useContext.colorScale, theme = _useContext.theme;
  var getScaledX = reactExports.useMemo(function() {
    return getScaledValueFactory(xScale, xAccessor);
  }, [xScale, xAccessor]);
  var getScaledY = reactExports.useMemo(function() {
...
function extend(commandsToExtend, referenceCommands, excludeSegment) {
  ...
  const countPointsPerSegment = arrayOfLength(numReferenceSegments).reduce(
    (accum, d, i) => {
      ...
      if (excludeSegment && insertIndex < commandsToExtend.length - 1 && excludeSegment(
...
const UsageChart = ({ label, dataset }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 border rounded-lg w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(InfoIcon, { className: "text-ring" })
    ] }),
...
function Dashboard() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ju, {
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(GeneralLayout, {
      children: [/* @__PURE__ */ jsxRuntimeExports.jsx("h1", {
        className: "font-bold mb-4 text-3xl",
        children: "Dashboard"
      }), /* @__PURE__ */ jsxRuntimeExports.jsx(UpgradeAccountBanner, {}), /* @__PURE__ */ jsxRuntimeExports.jsx("h2", {
        className: "font-bold mb-8 mt-10 text-2xl",
