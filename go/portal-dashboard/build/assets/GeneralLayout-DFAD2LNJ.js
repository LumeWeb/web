...
import { P as Progress, u as useIsBillingEnabled, A as Avatar, a as Avatar$1 } from "./avatar-BEvRnn4D.js";
import { T as TrashIcon, E as ExitIcon, a as ChevronDownIcon$1 } from "./index-DiXcXsr5.js";
import { d as Lr, o as oo } from "./index-DU1IfKY5.js";
import { B as Button, c as cn } from "./button-CzfLTIHt.js";
import { u as useUploader, T as TooltipProvider, a as Tooltip, b as TooltipTrigger, c as TooltipContent, D as DropdownMenu, e as DropdownMenuTrigger, f as DropdownMenuContent, s as DropdownMenuGroup, g as DropdownMenuItem, v as ThemeSwitcher } from "./useTheme-Wun3lQOi.js";
import { L as LumeLogo, d as discordLogoPng, l as lumeColorLogoPng } from "./LumeLogo-UyKObroS.js";
import { S as Sheet, a as SheetTrigger, b as SheetContent, c as SheetHeader, e as SheetDescription } from "./sheet-BiOScmXk.js";
import { f as CloudUploadIcon, B as BoxCheckedIcon, E as ExclamationCircleIcon, P as PageIcon, g as CloudSelectIcon, h as ChevronDownIcon, H as HamburgerMenuIcon } from "./icons-DfV8n6Ey.js";
import { b as DialogHeader, c as DialogTitle } from "./dialog-D6SmLySg.js";
...
import { E as ErrorList } from "./Forms-BYhGkaay.js";
...
import { u as useBaseStore } from "./usePortalUrl-Bjyn0q0k.js";
import { u as useLocation } from "./index-O1NGHMyc.js";
import { A as Alert, a as AlertTitle, b as AlertDescription } from "./alert-BS46AoM-.js";
/**
...
function NavigationItemContent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center flex-grow", children });
}
function NavigationSubItem({ children, href }) {
  const content = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center px-3 py-2 text-sm font-medium text-foreground/60 rounded-md transition-colors hover:opacity-50", children });
...
const NavItem = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(NavigationItem, { active, href: item.path, children: [
    ...
    (_b = (_a = item.children) == null ? void 0 : _a.filter((item2) => {
      ...
      return true;
    })) == null ? void 0 : _b.map((child) => /* @__PURE__ */ jsxRuntimeExports.jsx(NavigationSubItem, { href: child.path, children: child.label }, child.key))
  ] }, item.key);
};
