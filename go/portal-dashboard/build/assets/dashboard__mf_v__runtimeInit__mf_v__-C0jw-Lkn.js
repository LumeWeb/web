...
const encodeName = function(name2, prefix = "", withExt = false) {
  try {
...
const decodeName = function(name2, prefix, withExt) {
  try {
...
(function(exports) {
  ...
  const LOG_CATEGORY2 = "[ Federation Runtime ]";
  const logger2 = sdk.createLogger(LOG_CATEGORY2);
 ...
 ${sdk.safeToString(this.remoteInfo)}`);
  ...
  exports.isStaticResourcesEqual = isStaticResourcesEqual2;
  exports.matchRemoteWithNameAndExpose = matchRemoteWithNameAndExpose;
  exports.registerGlobalPlugins = registerGlobalPlugins;
  exports.resetFederationGlobalInfo = resetFederationGlobalInfo;
  exports.safeWrapper = safeWrapper2;
...
(function(exports) {
  var runtimeCore2 = index_cjs$2;
  var utils = utils_cjs;
  let FederationInstance = null;
  function init(options) {
    const instance = utils.getGlobalFederationInstance(options.name, options.version);
    if (!instance) {
      const FederationConstructor = runtimeCore2.getGlobalFederationConstructor() || runtimeCore2.FederationHost;
      FederationInstance = new FederationConstructor(options);
      runtimeCore2.setGlobalFederationInstance(FederationInstance);
  ...
  function loadRemote(...args) {
    runtimeCore2.assert(FederationInstance, "Please call init first");
  ...
  runtimeCore2.setGlobalFederationConstructor(runtimeCore2.FederationHost);
  Object.defineProperty(exports, "FederationHost", {
    enumerable: true,
    get: function() {
      return runtimeCore2.FederationHost;
    }
  });
  Object.defineProperty(exports, "Module", {
    enumerable: true,
    get: function() {
      return runtimeCore2.Module;
    }
  });
  Object.defineProperty(exports, "getRemoteEntry", {
    enumerable: true,
    get: function() {
      return runtimeCore2.getRemoteEntry;
    }
  });
  Object.defineProperty(exports, "getRemoteInfo", {
    enumerable: true,
    get: function() {
      return runtimeCore2.getRemoteInfo;
    }
  });
  Object.defineProperty(exports, "loadScript", {
    enumerable: true,
    get: function() {
      return runtimeCore2.loadScript;
    }
  });
  Object.defineProperty(exports, "loadScriptNode", {
    enumerable: true,
    get: function() {
      return runtimeCore2.loadScriptNode;
    }
  });
  Object.defineProperty(exports, "registerGlobalPlugins", {
    enumerable: true,
    get: function() {
      return runtimeCore2.registerGlobalPlugins;
    }
  });
...
var dashboard__mf_v__runtimeInit__mf_v__ = {
  initPromise,
  initResolve,
  initReject
};
export {
  dashboard__mf_v__runtimeInit__mf_v__ as d,
  index_cjs$3 as i
};
