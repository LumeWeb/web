...
const UsageChart = ({ label, dataset }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: containerRef, className: "p-2 lg:p-8 border border-border/30 rounded-lg w-full", children: [
