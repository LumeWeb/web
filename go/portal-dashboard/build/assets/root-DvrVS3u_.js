import { e as useLocation, f as useMatches, r as reactExports, g as useNavigate, h as useParams, R as React, j as jsxRuntimeExports, O as Outlet } from "./index-DVnsepjX.js";
import { G, i as it, K as Ko, B as Buffer, Q as QueryClient, a as QueryClientProvider, _ as _u } from "./index-CFr-6OM9.js";
import { u as useRemixContext, _ as _extends, L as Link, M as Meta, k as Links, S as Scripts } from "./components-CpdSlbpj.js";
import { S as SdkContextProvider, u as useSdk } from "./sdk-context-DS7Hx_ov.js";
import { T as ToastProvider, a as Toast, b as ToastTitle, c as ToastDescription, d as ToastClose, e as ToastViewport, f as ToastAction } from "./toast-BbonP983.js";
import { c as customInstance, P as PROTOCOL_S5, a as createProtocol, S as S5, M as Multihash, C as CID, b as CID_TYPES, U as Unpacker, m as metadataMagicByte, d as METADATA_TYPES, e as PinningProcess } from "./pinning-DIMD3mfc.js";
import { z } from "./index-Ja1h8Z59.js";
import { u as useScrollRestoration } from "./index-BPJinGo7.js";
...
var y = { addQueryPrefix: true, skipNulls: true, arrayFormat: "indices", encode: false, encodeValuesOnly: true }, E = { go: () => {
  ...
  return reactExports.useCallback(({ to: t, type: o, query: u, hash: i, options: { keepQuery: s, keepHash: p } = {} }) => {
    ...
    let f = Object.keys(c).length > 0, l = `#${(i || p && r || "").replace(/^#/, "")}`, T = l.length > 1, C = `${t || ""}${f ? G.stringify(c, y) : ""}${T ? l : ""}`;
    return o === "path" ? C : n(C, { replace: o === "replace" });
  }, [r, e, n]);
}, back: () => {
  let e = useNavigate();
  return () => {
  ...
  let e = useParams(), { pathname: r, search: n } = useLocation(), { resources: a } = reactExports.useContext(it), { resource: t, action: o, matchedRoute: u } = React.useMemo(() => Ko(r, a), [a, r]), i = u && r ? g(r, u) : {}, s = i.id;
  return reactExports.useCallback(() => {
    let c = G.parse(n, { ignoreQueryPrefix: true }), f = { ...i, ...e, ...c };
...
function SdkWrapper() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, {
    client: queryClient,
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(_u, {
