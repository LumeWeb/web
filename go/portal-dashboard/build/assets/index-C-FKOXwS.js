...
var Pr = o((e) => {
  let [t, r] = dashboard__loadShare__react__loadShare__.useState(false);
  return dashboard__loadShare__react__loadShare__.useEffect(() => {
...
var _e = o((e, t) => {
  let { mutationMode: r, undoableTimeout: s } = dashboard__loadShare__react__loadShare__.useContext(Qe);
...
var vt = o(() => {
  let { warnWhenUnsavedChanges: e } = dashboard__loadShare__react__loadShare__.useContext(Qe), { warnWhen: t, setWarnWhen: r } = dashboard__loadShare__react__loadShare__.useContext(eo);
  return { warnWhenUnsavedChanges: e, warnWhen: !!t, setWarnWhen: r ?? (() => {
  }) };
}, "useWarnAboutChange");
var to = o(() => {
  let { syncWithLocation: e } = dashboard__loadShare__react__loadShare__.useContext(Qe);
  return { syncWithLocation: e };
}, "useSyncWithLocation");
var Ta = o(() => {
  let { Title: e } = dashboard__loadShare__react__loadShare__.useContext(Qe);
  return e;
}, "useTitle");
var ge = o(() => {
  let { Footer: e, Header: t, Layout: r, OffLayoutArea: s, Sider: n, Title: i, hasDashboard: a, mutationMode: u, syncWithLocation: c, undoableTimeout: p, warnWhenUnsavedChanges: l, DashboardPage: m, LoginPage: y, catchAll: d, options: T, __initialized: x } = dashboard__loadShare__react__loadShare__.useContext(Qe);
...
function Ua({ v3LegacyAuthProviderCompatible: e = false, options: t, params: r } = {}) {
  let { getPermissions: s } = xe(), { getPermissions: n } = Ue(), { keys: i, preferLegacyKeys: a } = Z(), u = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQuery({ queryKey: i().auth().action("permissions").get(a), queryFn: n ? () => n(r) : () => Promise.resolve(void 0), enabled: !e && !!n, ...e ? {} : t, meta: { ...e ? {} : t == null ? void 0 : t.meta, ...k() } }), c = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQuery({ queryKey: [...i().auth().action("permissions").get(a), "v3LegacyAuthProviderCompatible"], queryFn: s ? () => s(r) : () => Promise.resolve(void 0), enabled: e && !!s, ...e ? t : {}, meta: { ...e ? t == null ? void 0 : t.meta : {}, ...k() } });
  return e ? c : u;
}
o(Ua, "usePermissions");
function no({ v3LegacyAuthProviderCompatible: e = false, queryOptions: t } = {}) {
  let { getUserIdentity: r } = xe(), { getIdentity: s } = Ue(), { keys: n, preferLegacyKeys: i } = Z(), a = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQuery({ queryKey: n().auth().action("identity").get(i), queryFn: s ?? (() => Promise.resolve({})), enabled: !e && !!s, retry: false, ...e === true ? {} : t, meta: { ...e === true ? {} : t == null ? void 0 : t.meta, ...k() } }), u = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQuery({ queryKey: [...n().auth().action("identity").get(i), "v3LegacyAuthProviderCompatible"], queryFn: r ?? (() => Promise.resolve({})), enabled: e && !!r, retry: false, ...e ? t : {}, meta: { ...e ? t == null ? void 0 : t.meta : {}, ...k() } });
  return e ? u : a;
}
o(no, "useGetIdentity");
var Dt = o(() => {
  let e = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQueryClient(), { keys: t, preferLegacyKeys: r } = Z();
  return o(async () => {
...
function Mr({ v3LegacyAuthProviderCompatible: e, mutationOptions: t } = {}) {
  let r = Dt(), s = oe(), n = Pe(), { push: i } = he(), { open: a, close: u } = He(), { logout: c } = xe(), { logout: p } = Ue(), { keys: l, preferLegacyKeys: m } = Z(), y = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationKey: l().auth().action("logout").get(m), mutationFn: p, onSuccess: async (T, x) => {
    ...
    a == null || a(ao(T));
  }, ...e === true ? {} : t, meta: { ...e === true ? {} : t == null ? void 0 : t.meta, ...k() } }), d = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationKey: [...l().auth().action("logout").get(m), "v3LegacyAuthProviderCompatible"], mutationFn: c, onSuccess: async (T, x) => {
...
function Ht({ v3LegacyAuthProviderCompatible: e, mutationOptions: t } = {}) {
  let r = Dt(), s = oe(), n = Pe(), { replace: i } = he(), a = Te(), { useLocation: u } = pe(), { search: c } = u(), { close: p, open: l } = He(), { login: m } = xe(), { login: y } = Ue(), { keys: d, preferLegacyKeys: T } = Z(), x = React.useMemo(() => {
  ...
  }, [s, a.params, c]), v = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationKey: d().auth().action("login").get(T), mutationFn: y, onSuccess: async ({ success: P, redirectTo: M, error: Q, successNotification: g }) => {
    ...
    l == null || l(io(P));
  }, ...e === true ? {} : t, meta: { ...e === true ? {} : t == null ? void 0 : t.meta, ...k() } }), f = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationKey: [...d().auth().action("login").get(T), "v3LegacyAuthProviderCompatible"], mutationFn: m, onSuccess: async (P) => {
...
function co({ v3LegacyAuthProviderCompatible: e, mutationOptions: t } = {}) {
  let r = Dt(), s = oe(), n = Pe(), { replace: i } = he(), { register: a } = xe(), { register: u } = Ue(), { close: c, open: p } = He(), { keys: l, preferLegacyKeys: m } = Z(), y = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationKey: l().auth().action("register").get(m), mutationFn: u, onSuccess: async ({ success: T, redirectTo: x, error: v, successNotification: f }) => {
    T && (c == null || c("register-error"), f && (p == null || p(Sa(f))), await r()), (v || !T) && (p == null || p(uo(v))), x ? s === "legacy" ? i(x) : n({ to: x, type: "replace" }) : s === "legacy" && i("/");
  }, onError: (T) => {
    p == null || p(uo(T));
  }, ...e === true ? {} : t, meta: { ...e === true ? {} : t == null ? void 0 : t.meta, ...k() } }), d = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationKey: [...l().auth().action("register").get(m), "v3LegacyAuthProviderCompatible"], mutationFn: a, onSuccess: async (T) => {
...
function lo({ v3LegacyAuthProviderCompatible: e, mutationOptions: t } = {}) {
  let r = oe(), s = Pe(), { replace: n } = he(), { forgotPassword: i } = xe(), { forgotPassword: a } = Ue(), { close: u, open: c } = He(), { keys: p, preferLegacyKeys: l } = Z(), m = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationKey: p().auth().action("forgotPassword").get(l), mutationFn: a, onSuccess: ({ success: d, redirectTo: T, error: x, successNotification: v }) => {
    d && (u == null || u("forgot-password-error"), v && (c == null || c(Aa(v)))), (x || !d) && (c == null || c(po(x))), T && (r === "legacy" ? n(T) : s({ to: T, type: "replace" }));
  }, onError: (d) => {
    c == null || c(po(d));
  }, ...e === true ? {} : t, meta: { ...e === true ? {} : t == null ? void 0 : t.meta, ...k() } }), y = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationKey: [...p().auth().action("forgotPassword").get(l), "v3LegacyAuthProviderCompatible"], mutationFn: i, onSuccess: (d) => {
...
function fo({ v3LegacyAuthProviderCompatible: e, mutationOptions: t } = {}) {
  let r = oe(), s = Pe(), { replace: n } = he(), { updatePassword: i } = xe(), { updatePassword: a } = Ue(), { close: u, open: c } = He(), { keys: p, preferLegacyKeys: l } = Z(), m = Te(), { useLocation: y } = pe(), { search: d } = y(), T = React.useMemo(() => r === "legacy" ? Dn.parse(d, { ignoreQueryPrefix: true }) ?? {} : m.params ?? {}, [d, m, r]), x = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationKey: p().auth().action("updatePassword").get(l), mutationFn: async (f) => a == null ? void 0 : a({ ...T, ...f }), onSuccess: ({ success: f, redirectTo: P, error: M, successNotification: Q }) => {
    f && (u == null || u("update-password-error"), Q && (c == null || c(Qa(Q)))), (M || !f) && (c == null || c(mo(M))), P && (r === "legacy" ? n(P) : s({ to: P, type: "replace" }));
  }, onError: (f) => {
    c == null || c(mo(f));
  }, ...e === true ? {} : t, meta: { ...e === true ? {} : t == null ? void 0 : t.meta, ...k() } }), v = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationKey: [...p().auth().action("updatePassword").get(l), "v3LegacyAuthProviderCompatible"], mutationFn: async (f) => i == null ? void 0 : i({ ...T, ...f }), onSuccess: (f) => {
...
function wr({ v3LegacyAuthProviderCompatible: e = false, params: t } = {}) {
  let { checkAuth: r } = xe(), { check: s } = Ue(), { keys: n, preferLegacyKeys: i } = Z(), a = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQuery({ queryKey: n().auth().action("check").params(t).get(i), queryFn: async () => await (s == null ? void 0 : s(t)) ?? {}, retry: false, enabled: !e, meta: { ...k() } }), u = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQuery({ queryKey: [...n().auth().action("check").params(t).get(i), "v3LegacyAuthProviderCompatible"], queryFn: async () => await (r == null ? void 0 : r(t)) ?? {}, retry: false, enabled: e, meta: { ...k() } });
  return e ? u : a;
}
o(wr, "useIsAuthenticated");
var Va = wr;
function Re({ v3LegacyAuthProviderCompatible: e = false } = {}) {
  let t = oe(), r = Pe(), { replace: s } = he(), { checkError: n } = xe(), { onError: i } = Ue(), { keys: a, preferLegacyKeys: u } = Z(), { mutate: c } = Mr({ v3LegacyAuthProviderCompatible: !!e }), { mutate: p } = Mr({ v3LegacyAuthProviderCompatible: !!e }), l = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationKey: a().auth().action("onError").get(u), ...i ? { mutationFn: i, onSuccess: ({ logout: y, redirectTo: d }) => {
    if (y) {
      p({ redirectPath: d });
      return;
    }
  ...
  } } : { mutationFn: () => ({}) }, meta: { ...k() } }), m = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationKey: [...a().auth().action("onError").get(u), "v3LegacyAuthProviderCompatible"], mutationFn: n, onError: (y) => {
    c({ redirectPath: y });
  }, meta: { ...k() } });
  return e ? m : l;
}
...
var fe = o(({ enabled: e, isLoading: t, interval: r, onInterval: s }) => {
  let [n, i] = dashboard__loadShare__react__loadShare__.useState(void 0), { options: a } = ge(), { overtime: u } = a, c = r ?? u.interval, p = s ?? (u == null ? void 0 : u.onInterval), l = typeof e < "u" ? e : typeof u.enabled < "u" ? u.enabled : true;
  return dashboard__loadShare__react__loadShare__.useEffect(() => {
    let m;
  ...
  }, [t, c, l]), dashboard__loadShare__react__loadShare__.useEffect(() => {
    p && n && p(n);
  }, [n]), { elapsedTime: n };
}, "useLoadingOvertime");
var $t = o(({ resource: e, config: t, filters: r, hasPagination: s, pagination: n, sorters: i, queryOptions: a, successNotification: u, errorNotification: c, meta: p, metaData: l, liveMode: m, onLiveEvent: y, liveParams: d, dataProviderName: T, overtimeOptions: x } = {}) => {
  ...
  let re = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQuery({ queryKey: k$1().data(L).resource(P ?? "").action("list").params({ ...U || {}, filters: w, hasPagination: V, ...V && { pagination: F }, ...i && { sorters: i }, ...(t == null ? void 0 : t.sort) && { sort: t == null ? void 0 : t.sort } }).get(E), queryFn: (R) => {
...
var go = o(({ resource: e, ids: t, queryOptions: r, successNotification: s, errorNotification: n, meta: i, metaData: a, liveMode: u, onLiveEvent: c, liveParams: p, dataProviderName: l, overtimeOptions: m }) => {
  ...
  let F = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQuery({ queryKey: g().data(D).resource(T).action("many").ids(...t ?? []).params({ ...h || {} }).get(C), queryFn: (G) => {
...
var To = o(({ id: e, resource: t, values: r, dataProviderName: s, successNotification: n, errorNotification: i, meta: a, metaData: u, mutationMode: c, undoableTimeout: p, onCancel: l, optimisticUpdateMap: m, invalidates: y, mutationOptions: d, overtimeOptions: T } = {}) => {
  let { resources: x, select: v } = q(), f = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQueryClient(), P = le(), { mutationMode: M, undoableTimeout: Q } = _e(), g = z(), C = ie(), { mutate: h } = Re({ v3LegacyAuthProviderCompatible: !!(C != null && C.isLegacy) }), D = Ye(), { log: k$1 } = Je(), { notificationDispatch: E } = ut(), L = Ce(), U = Ae(), w = ue(), { options: { textTransformers: N } } = ge(), { keys: b, preferLegacyKeys: F } = Z(), V = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationFn: ({ id: R = e, values: S = r, resource: B = t, mutationMode: H = c, undoableTimeout: $ = p, onCancel: X = l, meta: ne = a, metaData: Y = u, dataProviderName: O = s }) => {
...
var Xt = o(({ resource: e, values: t, dataProviderName: r, successNotification: s, errorNotification: n, invalidates: i, meta: a, metaData: u, mutationOptions: c, overtimeOptions: p } = {}) => {
  let l = ie(), { mutate: m } = Re({ v3LegacyAuthProviderCompatible: !!(l != null && l.isLegacy) }), y = le(), d = Ae(), { resources: T, select: x } = q(), v = z(), f = Ye(), { log: P } = Je(), M = Ce(), Q = ue(), { options: { textTransformers: g } } = ge(), { keys: C, preferLegacyKeys: h } = Z(), D = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationFn: ({ resource: b = e, values: F = t, meta: V = a, metaData: G = u, dataProviderName: W = r }) => {
    if (!F) throw ho;
    if (!b) throw xo;
...
var Po = o(({ mutationOptions: e, overtimeOptions: t } = {}) => {
  let r = ie(), { mutate: s } = Re({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) }), n = le(), { resources: i, select: a } = q(), u = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQueryClient(), { mutationMode: c, undoableTimeout: p } = _e(), { notificationDispatch: l } = ut(), m = z(), y = Ye(), { log: d } = Je(), T = Ce(), x = Ae(), v = ue(), { options: { textTransformers: f } } = ge(), { keys: P, preferLegacyKeys: M } = Z(), Q = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationFn: ({ id: C, mutationMode: h, undoableTimeout: D, resource: k2, onCancel: E, meta: L, metaData: U, dataProviderName: w, values: N }) => {
...
var bo = o(({ resource: e, values: t, dataProviderName: r, successNotification: s, errorNotification: n, meta: i, metaData: a, invalidates: u, mutationOptions: c, overtimeOptions: p } = {}) => {
  let l = le(), { resources: m, select: y } = q(), d = z(), T = Ye(), x = Ce(), v = Ae(), { log: f } = Je(), P = ue(), { options: { textTransformers: M } } = ge(), { keys: Q, preferLegacyKeys: g } = Z(), C = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationFn: ({ resource: w = e, values: N = t, meta: b = i, metaData: F = a, dataProviderName: V = r }) => {
    if (!N) throw Co;
    if (!w) throw Ro;
...
var ii = o(({ ids: e, resource: t, values: r, dataProviderName: s, successNotification: n, errorNotification: i, meta: a, metaData: u, mutationMode: c, undoableTimeout: p, onCancel: l, optimisticUpdateMap: m, invalidates: y, mutationOptions: d, overtimeOptions: T } = {}) => {
  let { resources: x, select: v } = q(), f = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQueryClient(), P = le(), M = z(), { mutationMode: Q, undoableTimeout: g } = _e(), C = ie(), { mutate: h } = Re({ v3LegacyAuthProviderCompatible: !!(C != null && C.isLegacy) }), { notificationDispatch: D } = ut(), k$1 = Ye(), E = Ce(), L = Ae(), { log: U } = Je(), w = ue(), { options: { textTransformers: N } } = ge(), { keys: b, preferLegacyKeys: F } = Z(), V = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationFn: ({ ids: R = e, values: S = r, resource: B = t, onCancel: H = l, mutationMode: $ = c, undoableTimeout: X = p, meta: ne = a, metaData: Y = u, dataProviderName: O = s }) => {
    if (!R) throw Yt;
    if (!S) throw Sr;
    if (!B) throw Zt;
...
var di = o(({ mutationOptions: e, overtimeOptions: t } = {}) => {
  let r = ie(), { mutate: s } = Re({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) }), { mutationMode: n, undoableTimeout: i } = _e(), a = le(), { notificationDispatch: u } = ut(), c = z(), p = Ye(), l = Ce(), m = Ae(), { log: y } = Je(), { resources: d, select: T } = q(), x = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQueryClient(), v = ue(), { options: { textTransformers: f } } = ge(), { keys: P, preferLegacyKeys: M } = Z(), Q = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation({ mutationFn: ({ resource: C, ids: h, mutationMode: D, undoableTimeout: k2, onCancel: E, meta: L, metaData: U, dataProviderName: w, values: N }) => {
...
var yi = o(({ url: e, method: t, config: r, queryOptions: s, successNotification: n, errorNotification: i, meta: a, metaData: u, dataProviderName: c, overtimeOptions: p }) => {
  ...
  if (M) {
    let g = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQuery({ queryKey: v().data(c).mutation("custom").params({ method: t, url: e, ...r, ...P || {} }).get(f), queryFn: (h) => M({ url: e, method: t, ...r, meta: { ...Q, queryContext: je(h) }, metaData: { ...Q, queryContext: je(h) } }), ...s, onSuccess: (h) => {
      var k2;
...
var xi = o(({ mutationOptions: e, overtimeOptions: t } = {}) => {
  let r = ie(), { mutate: s } = Re({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) }), n = Ce(), i = le(), a = z(), u = ue(), { keys: c, preferLegacyKeys: p } = Z(), l = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation(({ url: y, method: d, values: T, meta: x, metaData: v, dataProviderName: f, config: P }) => {
...
var le = o(() => {
  let e = dashboard__loadShare__react__loadShare__.useContext(Jt);
  return dashboard__loadShare__react__loadShare__.useCallback((r) => {
    if (r) {
...
var bi = o(({ resource: e, config: t, filters: r, hasPagination: s, pagination: n, sorters: i, queryOptions: a, successNotification: u, errorNotification: c, meta: p, metaData: l, liveMode: m, onLiveEvent: y, liveParams: d, dataProviderName: T, overtimeOptions: x }) => {
  ...
  let re = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useInfiniteQuery({ queryKey: k$1().data(L).resource(P).action("infinite").params({ ...U || {}, filters: w, hasPagination: V, ...V && { pagination: F }, ...i && { sorters: i }, ...(t == null ? void 0 : t.sort) && { sort: t == null ? void 0 : t.sort } }).get(E), queryFn: (R) => {
...
var Ae = o(() => {
  let { resources: e } = q(), t = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQueryClient(), { keys: r, preferLegacyKeys: s } = Z();
  return dashboard__loadShare__react__loadShare__.useCallback(async ({ resource: i, dataProviderName: a, invalidates: u, id: c, invalidationFilters: p = { type: "all", refetchType: "active" }, invalidationOptions: l = { cancelRefetch: false } }) => {
    if (u === false) return;
...
var js = o((e) => {
  let t = dashboard__loadShare__react__loadShare__.useRef(e);
  return isEqual(t.current, e) || (t.current = e), t.current;
}, "useMemoized");
var Ar = o((e, t) => {
  let r = js(t);
  return dashboard__loadShare__react__loadShare__.useMemo(e, r);
}, "useDeepMemo");
...
var en = {}, ft = dashboard__loadShare__react__loadShare__.createContext(en), tn = o(({ children: e, router: t }) => React.createElement(ft.Provider, { value: t ?? en }, e), "RouterContextProvider");
var vo = o(() => {
  let e = dashboard__loadShare__react__loadShare__.useContext(ft);
...
function q(e) {
  let { resources: t } = dashboard__loadShare__react__loadShare__.useContext(Rt), r = oe(), s = Te(), n = { resourceName: e && typeof e != "string" ? e.resourceName : e, resourceNameOrRouteName: e && typeof e != "string" ? e.resourceNameOrRouteName : e, recordItemId: e && typeof e != "string" ? e.recordItemId : void 0 }, i = o((m, y = true) => {
...
o(q, "useResource");
var rn = o(() => {
  let { resources: e } = dashboard__loadShare__react__loadShare__.useContext(Rt);
  return dashboard__loadShare__react__loadShare__.useCallback((r) => {
    let s = Ee(r, e, true);
...
var Pt = o(({ resource: e, params: t, channel: r, types: s, enabled: n = true, liveMode: i, onLiveEvent: a, dataProviderName: u, meta: c }) => {
  var f;
  let { resource: p, identifier: l } = q(e), { liveProvider: m } = dashboard__loadShare__react__loadShare__.useContext(mt), { liveMode: y, onLiveEvent: d } = dashboard__loadShare__react__loadShare__.useContext(Qe), T = i ?? y, x = Ae(), v = u ?? (c == null ? void 0 : c.dataProviderName) ?? ((f = p == null ? void 0 : p.meta) == null ? void 0 : f.dataProviderName);
...
var sn = o((e) => {
  let { liveMode: t } = dashboard__loadShare__react__loadShare__.useContext(Qe);
  return e ?? t;
}, "useLiveMode");
var ph = o(({ params: e, channel: t, types: r = ["*"], enabled: s = true, onLiveEvent: n, dataProviderName: i = "default", meta: a }) => {
  let { liveProvider: u } = dashboard__loadShare__react__loadShare__.useContext(mt);
  dashboard__loadShare__react__loadShare__.useEffect(() => {
    let c;
...
var Ye = o(() => {
  let { liveProvider: e } = dashboard__loadShare__react__loadShare__.useContext(mt);
  return e == null ? void 0 : e.publish;
}, "usePublish");
var Uo = dashboard__loadShare__react__loadShare__.createContext({ notifications: [], notificationDispatch: () => false }), Hi = [], $i = o((e, t) => {
  switch (t.type) {
    case "ADD":
  ...
  let [t, r] = dashboard__loadShare__react__loadShare__.useReducer($i, Hi), s = { notifications: t, notificationDispatch: r };
...
var ut = o(() => {
  let { notifications: e, notificationDispatch: t } = dashboard__loadShare__react__loadShare__.useContext(Uo);
  return { notifications: e, notificationDispatch: t };
}, "useCancelNotification");
var qt = dashboard__loadShare__react__loadShare__.createContext({}), cn = o(({ open: e, close: t, children: r }) => React.createElement(qt.Provider, { value: { open: e, close: t } }, r), "NotificationContextProvider");
var He = o(() => {
  let { open: e, close: t } = dashboard__loadShare__react__loadShare__.useContext(qt);
  return { open: e, close: t };
}, "useNotification");
var Ce = o(() => {
  let { open: e } = He();
  return dashboard__loadShare__react__loadShare__.useCallback((r, s) => {
...
var Eo = o(() => {
  let { i18nProvider: e } = dashboard__loadShare__react__loadShare__.useContext(Xe);
  return dashboard__loadShare__react__loadShare__.useCallback((t) => e == null ? void 0 : e.changeLocale(t), []);
}, "useSetLocale");
var z = o(() => {
  let { i18nProvider: e } = dashboard__loadShare__react__loadShare__.useContext(Xe);
...
var Lo = o(() => {
  let { i18nProvider: e } = dashboard__loadShare__react__loadShare__.useContext(Xe);
  return dashboard__loadShare__react__loadShare__.useCallback(() => e == null ? void 0 : e.getLocale(), []);
}, "useGetLocale");
var tP = o(() => {
  let e = z(), t = Eo(), r = Lo();
...
var fP = o(({ resourceName: e, resource: t, sorter: r, sorters: s, filters: n, maxItemCount: i, pageSize: a = 20, mapData: u = o((x) => x, "mapData"), exportOptions: c, unparseConfig: p, meta: l, metaData: m, dataProviderName: y, onError: d, download: T } = {}) => {
  let [x, v] = dashboard__loadShare__react__loadShare__.useState(false), f = le(), P = ue(), { resource: M, resources: Q, identifier: g } = q(I(t, e)), h = `${ht()(g, "plural")}-${(/* @__PURE__ */ new Date()).toLocaleString()}`, { getList: D } = f(ee(g, y, Q)), k2 = P({ resource: M, meta: I(l, m) });
...
var fn = o(() => {
  ...
  return dashboard__loadShare__react__loadShare__.useCallback(({ redirect: i, resource: a, id: u, meta: c = {} }) => {
...
var Pe = o(() => {
  let e = dashboard__loadShare__react__loadShare__.useContext(ft), { select: t } = q(), r = Ut(), n = React.useMemo(() => (e == null ? void 0 : e.go) ?? (() => () => {
  }), [e == null ? void 0 : e.go])();
  return dashboard__loadShare__react__loadShare__.useCallback((a) => {
...
var mR = o(({ resourceName: e, resource: t, mapData: r = o((l) => l, "mapData"), paparseOptions: s, batchSize: n = Number.MAX_SAFE_INTEGER, onFinish: i, meta: a, metaData: u, onProgress: c, dataProviderName: p } = {}) => {
  let [l, m] = dashboard__loadShare__react__loadShare__.useState(0), [y, d] = dashboard__loadShare__react__loadShare__.useState(0), [T, x] = dashboard__loadShare__react__loadShare__.useState(false), { resource: v, identifier: f } = q(t ?? e), P = ue(), M = bo(), Q = Xt(), g = P({ resource: v, meta: I(a, u) }), C;
  n === 1 ? C = Q : C = M;
  let h = o(() => {
    d(0), m(0), x(false);
  }, "handleCleanup"), D = o((E) => {
...
var TR = o(({ defaultVisible: e = false } = {}) => {
  let [t, r] = dashboard__loadShare__react__loadShare__.useState(e), s = dashboard__loadShare__react__loadShare__.useCallback(() => r(true), [t]), n = dashboard__loadShare__react__loadShare__.useCallback(() => r(false), [t]);
...
var Mu = o((e, t) => {
  let r = dashboard__loadShare__react__loadShare__.useContext(ft), s = r == null ? void 0 : r.Link, n = Pe(), i = "";
...
}, "LinkComponent"), Io = dashboard__loadShare__react__loadShare__.forwardRef(Mu);
var yt = o(() => Io, "useLink");
...
var pe = o(() => {
  let e = dashboard__loadShare__react__loadShare__.useContext(er), { useHistory: t, useLocation: r, useParams: s, Prompt: n, Link: i, routes: a } = e ?? gt;
...
var PC = o((e) => {
  let [t, r] = dashboard__loadShare__react__loadShare__.useState([]), [s, n] = dashboard__loadShare__react__loadShare__.useState([]), [i, a] = dashboard__loadShare__react__loadShare__.useState([]), { resource: u, sort: c, sorters: p, filters: l = [], optionLabel: m = "title", optionValue: y = "id", searchField: d = typeof m == "string" ? m : "title", debounce: T = 300, successNotification: x, errorNotification: v, defaultValueQueryOptions: f, queryOptions: P, fetchSize: M, pagination: Q, hasPagination: g = false, liveMode: C, defaultValue: h = [], selectedOptionsOrder: D = "in-place", onLiveEvent: k2, onSearch: E, liveParams: L, meta: U, metaData: w, dataProviderName: N, overtimeOptions: b } = e, F = dashboard__loadShare__react__loadShare__.useCallback((O) => typeof m == "string" ? get(O, m) : m(O), [m]), V = dashboard__loadShare__react__loadShare__.useCallback((O) => typeof y == "string" ? get(O, y) : y(O), [y]), { resource: G, identifier: W } = q(u), j = ue()({ resource: G, meta: I(U, w) }), re = Array.isArray(h) ? h : [h], te = dashboard__loadShare__react__loadShare__.useCallback((O) => {
  ...
  } }, overtimeOptions: { enabled: false }, meta: j, metaData: j, liveMode: "off", dataProviderName: N }), B = dashboard__loadShare__react__loadShare__.useCallback((O) => {
...
function IC({ initialCurrent: e, initialPageSize: t, hasPagination: r = true, pagination: s, initialSorter: n, permanentSorter: i = En, defaultSetFilterBehavior: a, initialFilter: u, permanentFilter: c = Un, filters: p, sorters: l, syncWithLocation: m, resource: y, successNotification: d, errorNotification: T, queryOptions: x, liveMode: v, onLiveEvent: f, liveParams: P, meta: M, metaData: Q, dataProviderName: g, overtimeOptions: C } = {}) {
  ...
  let [me, ce] = dashboard__loadShare__react__loadShare__.useState(Lr(ne, ae ?? [])), [ve, rt] = dashboard__loadShare__react__loadShare__.useState(Er($, J ?? [])), [Ke, Ct] = dashboard__loadShare__react__loadShare__.useState(O), [Ge, Tt] = dashboard__loadShare__react__loadShare__.useState(_), xt = o(() => {
    if (E === "new") {
  ...
  }, [U]), dashboard__loadShare__react__loadShare__.useEffect(() => {
    if (D) {
      let Ie = xt();
  ...
  let or = $t({ resource: Ne, hasPagination: r, pagination: { current: Ke, pageSize: Ge, mode: s == null ? void 0 : s.mode }, filters: F ? St($, ve) : void 0, sorters: V ? Ur(ne, me) : void 0, queryOptions: x, overtimeOptions: C, successNotification: d, errorNotification: T, meta: se, metaData: se, liveMode: k2, liveParams: P, onLiveEvent: f, dataProviderName: g }), Bo = dashboard__loadShare__react__loadShare__.useCallback((Ie) => {
    rt((ot) => St($, Ie, ot));
  }, [$]), Ko = dashboard__loadShare__react__loadShare__.useCallback((Ie) => {
    rt(St($, Ie));
  }, [$]), Go = dashboard__loadShare__react__loadShare__.useCallback((Ie) => {
    rt((ot) => St($, Ie(ot)));
  }, [$]), oa = dashboard__loadShare__react__loadShare__.useCallback((Ie, ot = Y) => {
    typeof Ie == "function" ? Go(Ie) : ot === "replace" ? Ko(Ie) : Bo(Ie);
  }, [Go, Ko, Bo]), Oo = dashboard__loadShare__react__loadShare__.useCallback((Ie) => {
    ce(() => Ur(ne, Ie));
  }, [ne]);
...
var Je = o(({ logMutationOptions: e, renameMutationOptions: t } = {}) => {
  let r = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQueryClient(), s = dashboard__loadShare__react__loadShare__.useContext(Et), { keys: n, preferLegacyKeys: i } = Z(), a = ie(), { resources: u } = dashboard__loadShare__react__loadShare__.useContext(Rt), { data: c, refetch: p, isLoading: l } = no({ v3LegacyAuthProviderCompatible: !!(a != null && a.isLegacy), queryOptions: { enabled: !!(s != null && s.create) } }), m = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation(async (d) => {
    var f, P, M, Q, g;
  ...
  }, { mutationKey: n().audit().action("log").get(), ...e, meta: { ...e == null ? void 0 : e.meta, ...k() } }), y = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useMutation(async (d) => {
    var T;
...
var eb = o(({ resource: e, action: t, meta: r, author: s, metaData: n, queryOptions: i }) => {
  let { get: a } = dashboard__loadShare__react__loadShare__.useContext(Et), { keys: u, preferLegacyKeys: c } = Z();
  return dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQuery({ queryKey: u().audit().resource(e).action("list").params(r).get(c), queryFn: () => (a == null ? void 0 : a({ resource: e, action: t, author: s, meta: r, metaData: n })) ?? Promise.resolve([]), enabled: typeof a < "u", ...i, retry: false, meta: { ...i == null ? void 0 : i.meta, ...k() } });
}, "useLogList");
var fb = o(({ meta: e = {} } = {}) => {
  let t = oe(), { i18nProvider: r } = dashboard__loadShare__react__loadShare__.useContext(Xe), s = Te(), n = z(), { resources: i, resource: a, action: u } = q(), { options: { textTransformers: c } } = ge(), p = [];
...
var ko = dashboard__loadShare__react__loadShare__.createContext({}), Zu = o(({ children: e, value: t }) => {
  let r = Br(), s = dashboard__loadShare__react__loadShare__.useMemo(() => ({ ...r, ...t }), [r, t]);
  return React.createElement(ko.Provider, { value: s }, e);
}, "MetaContextProvider"), Br = o(() => {
  if (!dashboard__loadShare__react__loadShare__.useContext(ko)) throw new Error("useMetaContext must be used within a MetaContextProvider");
  return dashboard__loadShare__react__loadShare__.useContext(ko);
}, "useMetaContext");
var ue = o(() => {
...
function tc(e) {
  let t = z(), { keys: r, preferLegacyKeys: s } = Z(), n = dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.useQueryClient(), i = Ae(), { identifier: a, id: u } = qe({ resource: e.resource, id: e.id }), { resources: c } = q(), p = !!n.isFetching({ queryKey: r().data(ee(a, e.dataProviderName, c)).resource(a).action("one").get(s) }), l = o(() => {
...
var sc = o(() => {
  let [e, t] = dashboard__loadShare__react__loadShare__.useState(), r = z(), { push: s } = he(), n = Pe(), i = oe(), { resource: a, action: u } = q();
  return dashboard__loadShare__react__loadShare__.useEffect(() => {
...
var Yr = o(() => {
  let [e, t] = dashboard__loadShare__react__loadShare__.useState(""), [r, s] = dashboard__loadShare__react__loadShare__.useState(""), n = z(), i = ie(), { mutate: a } = Ht({ v3LegacyAuthProviderCompatible: !!(i != null && i.isLegacy) });
...
var $n = o(({ wrapperProps: e, contentProps: t, renderContent: r, formProps: s, title: n = void 0, mutationVariables: i }) => {
  let a = z(), u = ie(), { mutate: c, isLoading: p } = fo({ v3LegacyAuthProviderCompatible: !!(u != null && u.isLegacy) }), [l, m] = dashboard__loadShare__react__loadShare__.useState(""), [y, d] = dashboard__loadShare__react__loadShare__.useState(""), T = React.createElement("div", { ...t }, React.createElement("h1", { style: { textAlign: "center" } }, a("pages.updatePassword.title", "Update Password")), React.createElement("hr", null), React.createElement("form", { onSubmit: (x) => {
...
var uc = [{ title: "Documentation", description: "Learn about the technical details of using Refine in your projects.", link: "https://refine.dev/docs", iconUrl: "https://refine.ams3.cdn.digitaloceanspaces.com/welcome-page/book.svg" }, { title: "Tutorial", description: "Learn how to use Refine by building a fully-functioning CRUD app, from scratch to full launch.", link: "https://refine.dev/tutorial", iconUrl: "https://refine.ams3.cdn.digitaloceanspaces.com/welcome-page/hat.svg" }, { title: "Templates", description: "Explore a range of pre-built templates, perfect everything from admin panels to dashboards and CRMs.", link: "https://refine.dev/templates", iconUrl: "https://refine.ams3.cdn.digitaloceanspaces.com/welcome-page/application.svg" }, { title: "Community", description: "Join our Discord community and keep up with the latest news.", link: "https://discord.gg/refine", iconUrl: "https://refine.ams3.cdn.digitaloceanspaces.com/welcome-page/discord.svg" }], zn = o(() => {
  ...
  let { title: t, description: r, iconUrl: s, link: n } = e, [i, a] = dashboard__loadShare__react__loadShare__.useState(false);
...
var fc = "4.57.9", jn = o(() => {
  var P;
  let e = yo(), t = dashboard__loadShare__react__loadShare__.useContext(Et), { liveProvider: r } = dashboard__loadShare__react__loadShare__.useContext(mt), s = dashboard__loadShare__react__loadShare__.useContext(er), n = dashboard__loadShare__react__loadShare__.useContext(Jt), { i18nProvider: i } = dashboard__loadShare__react__loadShare__.useContext(Xe), a = dashboard__loadShare__react__loadShare__.useContext(qt), u = dashboard__loadShare__react__loadShare__.useContext(ct), { resources: c } = q(), p = ge(), l = !!t.create || !!t.get || !!t.update, m = !!(r != null && r.publish) || !!(r != null && r.subscribe) || !!(r != null && r.unsubscribe), y = !!s.useHistory || !!s.Link || !!s.Prompt || !!s.useLocation || !!s.useParams, d = !!n, T = !!(i != null && i.changeLocale) || !!(i != null && i.getLocale) || !!(i != null && i.translate), x = !!a.close || !!a.open, v = !!u.can, f = (P = p == null ? void 0 : p.options) == null ? void 0 : P.projectId;
...
var Rc = o(({ legacyAuthProvider: e, authProvider: t, dataProvider: r, legacyRouterProvider: s, routerProvider: n, notificationProvider: i, accessControlProvider: a, auditLogProvider: u, resources: c, DashboardPage: p, ReadyPage: l, LoginPage: m, catchAll: y, children: d, liveProvider: T, i18nProvider: x, Title: v, Layout: f, Sider: P, Header: M, Footer: Q, OffLayoutArea: g, onLiveEvent: C, options: h }) => {
  let { optionsWithDefaults: D, disableTelemetryWithDefault: k2, reactQueryWithDefaults: E } = Jr({ options: h }), L = Ar(() => {
    var b;
    return E.clientConfig instanceof dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.QueryClient ? E.clientConfig : new dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.QueryClient({ ...E.clientConfig, defaultOptions: { ...E.clientConfig.defaultOptions, queries: { refetchOnWindowFocus: false, keepPreviousData: true, ...(b = E.clientConfig.defaultOptions) == null ? void 0 : b.queries } } });
  }, [E.clientConfig]);
...
var Dc = o(({ children: e, Layout: t, Sider: r, Header: s, Title: n, Footer: i, OffLayoutArea: a }) => {
  ...
  return dashboard__loadShare__react__loadShare__.useEffect(() => (r && window.addEventListener("beforeunload", n), window.removeEventListener("beforeunload", n)), [r]), React.createElement(e, { when: r, message: t("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes."), setWarnWhen: s });
}, "UnsavedPrompt");
...
var ta = [`
    ...
    `];
var kc = "If you find Refine useful, you can contribute to its growth by giving it a star on GitHub", Fc = o(({ containerStyle: e }) => (dashboard__loadShare__react__loadShare__.useEffect(() => {
