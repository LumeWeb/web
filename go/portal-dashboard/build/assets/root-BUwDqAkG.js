import { e as useLocation, f as useMatches, r as reactExports, g as useNavigate, h as useParams, R as React, j as jsxRuntimeExports, O as Outlet } from "./index-BIsqO_uY.js";
import { l as lib, a as at, N as No, B as Buffer, Q as QueryClient, b as QueryClientProvider, z as zu } from "./index-Cb6cVh9L.js";
import { u as useRemixContext, a as _extends, L as Link, M as Meta, b as Links, S as Scripts } from "./components-C01XGMk1.js";
import { S as SdkContextProvider, u as useSdk } from "./sdk-context-tsvDc9Pk.js";
import { T as ToastProvider, a as Toast, b as ToastTitle, c as ToastDescription, d as ToastClose, e as ToastViewport, f as ToastAction } from "./toast-CSftXIOc.js";
import { c as customInstance, P as PROTOCOL_S5, a as createProtocol, S as S5, M as Multihash, C as CID, b as CID_TYPES, U as Unpacker, m as metadataMagicByte, d as METADATA_TYPES, e as PinningProcess } from "./pinning-BsL2ituL.js";
import { u as useScrollRestoration } from "./index-BVHF9LaM.js";
...
const stylesheet = "/assets/tailwind-CjxmpzhI.css";
var g = (e, r) => {
  let n = {}, a = r.replace(/^\/|\/$/g, ""), t = e.replace(/^\/|\/$/g, ""), o = a.split("/"), u = t.split("/");
  return o.forEach((i, s) => {
    var p;
    i.startsWith(":") && ((p = u[s]) == null ? void 0 : p.length) > 0 && (n[i.replace(":", "")] = u[s]);
  }), n;
};
var h = (e) => {
  if (typeof e > "u")
...
var y = { addQueryPrefix: true, skipNulls: true, arrayFormat: "indices", encode: false, encodeValuesOnly: true }, $ = { go: () => {
  let { search: e, hash: r } = useLocation(), n = useNavigate();
  return reactExports.useCallback(({ to: t, type: o, query: u, hash: i, options: { keepQuery: s, keepHash: p } = {} }) => {
    let c = { ...s && e && lib.parse(e, { ignoreQueryPrefix: true }), ...u };
    c.to && (c.to = encodeURIComponent(`${c.to}`));
    let f = Object.keys(c).length > 0, l = `#${(i || p && r || "").replace(/^#/, "")}`, T = l.length > 1, P = `${t || ""}${f ? lib.stringify(c, y) : ""}${T ? l : ""}`;
    return o === "path" ? P : n(P, { replace: o === "replace" });
  }, [r, e, n]);
}, back: () => {
  let e = useNavigate();
  return () => {
  ...
  let e = useParams(), { pathname: r, search: n } = useLocation(), { resources: a } = reactExports.useContext(at), { resource: t, action: o, matchedRoute: u } = React.useMemo(() => No(r, a), [a, r]), i = u && r ? g(r, u) : {}, s = i.id;
  return reactExports.useCallback(() => {
    let c = lib.parse(n, { ignoreQueryPrefix: true }), f = { ...i, ...e, ...c };
    return { ...t && { resource: t }, ...o && { action: o }, ...s && { id: decodeURIComponent(s) }, ...(e == null ? void 0 : e.id) && { id: decodeURIComponent(e.id) }, pathname: r, params: { ...f, current: h(f.current), pageSize: h(f.pageSize), to: f.to ? decodeURIComponent(f.to) : void 0 } };
  }, [r, n, e, t, o, i, s]);
}, Link: React.forwardRef(function(r, n) {
  return React.createElement(Link, { ...r, ref: n });
}) };
const TOAST_LIMIT = 1;
...
function Root() {
  const [portalUrl, setPortalUrl] = reactExports.useState("https://alpha.pinner.xyz");
...
function SdkWrapper() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, {
    client: queryClient,
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(zu, {
