import { j as jsxRuntimeExports } from "./dashboard__loadShare__react_mf_2_dom__loadShare__-CxucHwhd.js";
import { R as React } from "./dashboard__loadShare__react__loadShare__-B-YtubD3.js";
import { c as createEnv, a as createRoot } from "./index-Psk6eg-4.js";
import { d as dashboard__loadShare___mf_0_refinedev_mf_1_core__loadShare__, a as dashboard__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_core__loadShare__ } from "./dashboard__loadShare___mf_0_refinedev_mf_1_core__loadShare__-CA_bmIPS.js";
import { d as dashboard__mf_v__runtimeInit__mf_v__, i as index_cjs } from "./dashboard__mf_v__runtimeInit__mf_v__-C0jw-Lkn.js";
import { d as dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__ } from "./dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__-Cr_NkuYy.js";
...
import { z, d as dashboard__loadShare__react_mf_2_router__loadShare__ } from "./index-BgD9ZCss.js";
      ...
      function(modules) {
        ...
        function(module2, __webpack_exports__, __webpack_require__) {
          ...
          function _createForOfIteratorHelper(o, allowArrayLike) {
            var it;
            if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) {
              if (Array.isArray(o) || (it = renderer_unsupportedIterableToArray(o)) || allowArrayLike) {
                if (it) o = it;
                var i = 0;
                var F = function F2() {
                };
          ...
          function attach(hook, rendererID, renderer, global) {
            ...
            function updateComponentFilters(componentFilters) {
              ...
              hook.getFiberRoots(rendererID).forEach(function(root2) {
                currentRootID = getOrGenerateFiberID(root2.current);
              ...
              hook.getFiberRoots(rendererID).forEach(function(root2) {
                currentRootID = getOrGenerateFiberID(root2.current);
                setRootPseudoKey(currentRootID, root2.current);
                mountFiberRecursively(root2.current, null, false, false);
                flushPendingEvents();
                currentRootID = -1;
              });
                ...
                hook.getFiberRoots(rendererID).forEach(function(root2) {
                  ...
                  if (isProfiling && rootSupportsProfiling(root2)) {
                    currentCommitProfilingMetadata = {
                      ...
                      maxActualDuration: 0,
                      priorityLevel: null,
                      updaters: getUpdatersList(root2),
                      effectDuration: null,
            ...
            function getUpdatersList(root2) {
              return root2.memoizedUpdaters != null ? Array.from(root2.memoizedUpdaters).filter(function(fiber) {
              ...
              if (isProfiling && rootSupportsProfiling(root2)) {
                if (currentCommitProfilingMetadata !== null) {
                  var _getEffectDurations = Object(backend_utils[
                    "h"
                    /* getEffectDurations */
                  ])(root2), effectDuration = _getEffectDurations.effectDuration, passiveEffectDuration = _getEffectDurations.passiveEffectDuration;
            ...
            function startProfiling(shouldRecordChangeDescriptions) {
              ...
              hook.getFiberRoots(rendererID).forEach(function(root2) {
                var rootID = getFiberIDThrows(root2.current);
                displayNamesByRootID.set(rootID, getDisplayNameForRoot(root2.current));
                if (shouldRecordChangeDescriptions) {
                  crawlToInitializeContextsMap(root2.current);
                }
              });
              isProfiling = true;
        ...
        function(module2, exports2, __webpack_require__) {
          ...
          function U(a, b, d, c, e) {
            ...
            if (h) return h = a, e = e(h), a = "" === c ? "." + T(h, 0) : c, M(e) ? (d = "", null != a && (d = a.replace(S, "$&/") + "/"), U(e, b, d, "", function(a2) {
              return a2;
          ...
          exports2.version = "18.2.0-experimental-be1fd48e9-20220531";
        },
        /* 32 */
        /***/
        function(module2, __webpack_exports__, __webpack_require__) {
          ...
          var OverlayRect = /* @__PURE__ */ function() {
            function OverlayRect2(doc, container2) {
          ...
          var OverlayTip = /* @__PURE__ */ function() {
            function OverlayTip2(doc, container2) {
          ...
          var agent_Agent = /* @__PURE__ */ function(_EventEmitter) {
            ...
            function Agent(bridge) {
              ...
              agent_defineProperty(agent_assertThisInitialized(_this), "overrideHookState", function(_ref14) {
                var id = _ref14.id;
                _ref14.hookID;
                var path = _ref14.path, rendererID = _ref14.rendererID, wasForwarded = _ref14.wasForwarded, value = _ref14.value;
                if (!wasForwarded) {
                  _this.overrideValueAtPath({
                    id,
                    path,
          ...
          function connectToDevTools2(options) {
            ...
            function scheduleRetry() {
              if (retryTimeoutID === null) {
                retryTimeoutID = setTimeout(function() {
                  return connectToDevTools2(options);
...
const { connectToDevTools } = backend;
connectToDevTools();
...
[
  [dashboard__loadShare___mf_0_refinedev_mf_1_core__loadShare__.RefineContext, "RefineContext"],
  [dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.defaultContext, "QueryClientContext"],
  [dashboard__loadShare__react_mf_2_router__loadShare__.UNSAFE_DataRouterContext, "DataRouterContext"],
  [dashboard__loadShare__react_mf_2_router__loadShare__.UNSAFE_DataRouterStateContext, "DataRouterStateContext"],
  [dashboard__loadShare__react_mf_2_router__loadShare__.UNSAFE_FetchersContext, "FetchersContext"],
  [dashboard__loadShare__react_mf_2_router__loadShare__.UNSAFE_LocationContext, "LocationContext"],
  [dashboard__loadShare__react_mf_2_router__loadShare__.UNSAFE_NavigationContext, "NavigationContext"],
  [dashboard__loadShare__react_mf_2_router__loadShare__.UNSAFE_RouteContext, "RouteContext"],
  [dashboard__loadShare___mf_0_refinedev_mf_1_core__loadShare__.LegacyAuthContext, "LegacyAuthContext"],
  [dashboard__loadShare___mf_0_refinedev_mf_1_core__loadShare__.AuthBindingsContext, "AuthBindingsContext"],
  [dashboard__loadShare___mf_0_refinedev_mf_1_core__loadShare__.RouterContext, "RouterContext"],
  [dashboard__loadShare__react_mf_2_hook_mf_2_form__loadShare__.HookFormContext, "HookFormContext"],
  [dashboard__loadShare___mf_0_refinedev_mf_1_core__loadShare__.ResourceContext, "ResourceContext"],
  [dashboard__loadShare___mf_0_refinedev_mf_1_core__loadShare__.DataContext, "DataContext"],
  [dashboard__loadShare___mf_0_refinedev_mf_1_core__loadShare__.NotificationContext, "NotificationContext"]
].forEach((item) => dashboard__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_core__loadShare__.registerBridgedContext(item[0], item[1]));
function App() {
  const opts = {
