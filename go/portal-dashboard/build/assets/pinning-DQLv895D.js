...
import { l as global, B as Buffer2, n as Buffer$1, p as path } from "./index-CdKFiKW0.js";
import { g as getDefaultExportFromCjs$1, k as commonjsGlobal } from "./index-D_nKaDFf.js";
...
utils$3.reduceDescriptors(AxiosHeaders$3.prototype, ({ value }, key) => {
...
utils$3.freezeMethods(AxiosHeaders$3);
const AxiosHeaders$4 = AxiosHeaders$3;
...
const headersToObject$1 = (thing) => thing instanceof AxiosHeaders$4 ? { ...thing } : thing;
...
utils$3.forEach(["delete", "get", "head", "options"], function forEachMethodNoData(method) {
  Axios$4.prototype[method] = function(url, config) {
...
const CancelToken$4 = CancelToken$3;
...
const HttpStatusCode$4 = HttpStatusCode$3;
function createInstance$1(defaultConfig) {
  const context = new Axios$5(defaultConfig);
  const instance = bind$1(Axios$5.prototype.request, context);
  utils$3.extend(instance, Axios$5.prototype, context, { allOwnKeys: true });
...
axios$1.Axios = Axios$5;
axios$1.CanceledError = CanceledError$2;
axios$1.CancelToken = CancelToken$4;
...
axios$1.AxiosHeaders = AxiosHeaders$4;
...
axios$1.HttpStatusCode = HttpStatusCode$4;
...
function createInstance(defaultConfig) {
  ...
  const instance = bind(Axios$3.prototype.request, context);
...
const customInstance = (config, options) => {
  ...
  const instance = Axios$1.create({ baseURL: options == null ? void 0 : options.baseURL });
  const promise = instance({
    signal: abort.signal,
    ...config,
    ...options
