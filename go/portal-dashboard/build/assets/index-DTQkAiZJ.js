import { i as index_cjs } from "./dashboard__mf_v__runtimeInit__mf_v__-C0jw-Lkn.js";
...
import { C as CircleAlert } from "./circle-alert-xe346N1H.js";
import "./createLucideIcon-Od_tcS2A.js";
...
let ErrorBoundary$1 = class ErrorBoundary2 extends dashboard__loadShare__react__loadShare__.Component {
  constructor(props) {
    super(props);
...
function ContextBridgeProvider({
  ...
  const value2 = dashboard__loadShare__react__loadShare__.useContext(context || DummyContext);
  dashboard__loadShare__react__loadShare__.useEffect(() => {
    if (context) {
...
function RemoteContextConsumer({
  ...
  const [value2, setValue] = dashboard__loadShare__react__loadShare__.useState(() => {
...
const FrameworkContext = dashboard__loadShare__react__loadShare__.createContext(
  null
);
...
function createBridgeComponent(Component) {
  const WrappedComponent = dashboard__loadShare__react__loadShare__.forwardRef(
    (props, ref) => {
...
function WidgetArea({ widgetAreaId }) {
  ...
  const [widgets, setWidgets] = dashboard__loadShare__react__loadShare__.useState([]);
  dashboard__loadShare__react__loadShare__.useEffect(() => {
    if (!framework) {
      return;
    }
