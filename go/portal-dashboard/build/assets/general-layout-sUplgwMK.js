...
const UploadFileButton = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "lg", className: "w-full text-base font-semibold bg-upload-file-background hover:bg-current/60 text-gray-800 mt-10 lg:mt-4", children: [
