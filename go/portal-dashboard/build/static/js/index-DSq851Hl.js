...
function useOutlet(context) {
  ...
  if (outlet) {
    return /* @__PURE__ */ dashboard__loadShare__react__loadShare__.createElement(OutletContext.Provider, { value: context }, outlet);
  }
  return outlet;
}
function useParams() {
...
function RouterProvider({
  ...
  let logErrorsAndSetState = dashboard__loadShare__react__loadShare__.useCallback(
    (newState) => {
    ...
    (newState, { deletedFetchers, flushSync, viewTransitionOpts }) => {
      ...
      if (!viewTransitionOpts || !isViewTransitionAvailable) {
        if (reactDomFlushSyncImpl && flushSync) {
          ...
          dashboard__loadShare__react__loadShare__.startTransition(() => logErrorsAndSetState(newState));
        }
        return;
      }
      if (reactDomFlushSyncImpl && flushSync) {
...
function RSCHydratedRouter({
  ...
  if (payload.type !== "render") throw new Error("Invalid payload type");
  let { router, routeModules } = dashboard__loadShare__react__loadShare__.useMemo(
  ...
  let [location2, setLocation] = dashboard__loadShare__react__loadShare__.useState(router.state.location);
  dashboard__loadShare__react__loadShare__.useLayoutEffect(
