...
var useQuerySubscription = (queryClient) => {
  const { ws } = dashboard__loadShare__react__loadShare__.useContext(DevToolsContext);
...
var useList = /* @__PURE__ */ __name(({
  ...
  const memoizedSelect = dashboard__loadShare__react__loadShare__.useMemo(() => {
    return (rawData) => {
      var _a2;
      let data = rawData;
...
var useGetLocale = /* @__PURE__ */ __name(() => {
  ...
  return dashboard__loadShare__react__loadShare__.useCallback(() => i18nProvider.getLocale(), []);
}, "useGetLocale");
...
function useTable({
  ...
  const [currentPage, setCurrentPage] = dashboard__loadShare__react__loadShare__.useState(defaultCurrentPage);
...
var Refine = /* @__PURE__ */ __name(({
    ...
    return new dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.QueryClient({
      ...
      defaultOptions: {
        ...
        queries: {
          ...
          placeholderData: dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.keepPreviousData,
  ...
  return /* @__PURE__ */ React.createElement(dashboard__loadShare___mf_0_tanstack_mf_1_react_mf_2_query__loadShare__.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ React.createElement(NotificationContextProvider, { ...notificationProviderContextValues }, /* @__PURE__ */ React.createElement(
    AuthProviderContextProvider,
    {
      ...authProvider ?? {},
