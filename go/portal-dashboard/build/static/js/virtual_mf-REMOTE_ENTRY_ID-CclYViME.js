...
const importMap = {
      ...
      ,
        "@lumeweb/portal-framework-core": async () => {
          let pkg = await __vitePreload(() => import('./index-CS99VSKh.js'),true              ?__vite__mapDeps([15,16,10,1,4,5,6,17,3,8,18,19]):void 0);
            return pkg;
        }
      ,
