...
import exposesMap from './virtualExposes-DD5fkPrw.js';
...
const importMap = {
        ...
        "@lumeweb/portal-framework-core": async () => {
          let pkg = await import('./index-Botw0KjP.js');
          return pkg
        }
      ,
        "@lumeweb/portal-framework-ui": async () => {
          let pkg = await import('./index-BNyoIg6E.js');
          return pkg
        }
      ,
        "@refinedev/core": async () => {
          let pkg = await import('./index-Dx4Cf_6M.js');
          return pkg
        }
      ,
        "react": async () => {
      ...
      ,
        "react-router": async () => {
          let pkg = await import('./index-CjpS_hGS.js');
          return pkg
        }
      ,
        "@lumeweb/portal-framework-ui-core": async () => {
          let pkg = await import('./index-CcISnGsG.js');
          return pkg
        }
      ,
        "react-hook-form": async () => {
          let pkg = await import('./index.esm-BrGDNVEI.js');
          return pkg
        }
      ,
        "@tanstack/react-query": async () => {
          let pkg = await import('./index-D7APFXKe.js');
          return pkg
        }
      ,
        "react-dom": async () => {
          let pkg = await import('./index-BsO6zc3H.js').then(n => n.index);
          return pkg
        }
