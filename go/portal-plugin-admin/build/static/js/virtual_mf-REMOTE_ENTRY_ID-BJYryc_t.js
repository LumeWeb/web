...
const importMap = {
        ...
        "@lumeweb/portal-framework-core": async () => {
          let pkg = await import('./index-BDMRXZnO.js');
          return pkg
        }
      ,
        "@lumeweb/portal-framework-ui": async () => {
          let pkg = await import('./index-DgU_HoMh.js');
          return pkg
        }
      ,
      ...
      ,
        "@lumeweb/portal-framework-ui-core": async () => {
          let pkg = await import('./index-E7ffZve-.js');
          return pkg
        }
      ,
      ...
      ,
        "@tanstack/react-query": async () => {
          let pkg = await import('./index-Dydof9-I.js');
          return pkg
        }
      ,
        "react-dom": async () => {
