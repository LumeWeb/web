import { core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__ } from './core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__-DvQP2D35.js';
...
import { core_admin__loadShare__react_mf_2_router__loadShare__, z, anyType, ZodArray, ZodObject, ZodEffects, ZodOptional, ZodCatch, ZodIntersection, ZodUnion, ZodDiscriminatedUnion, ZodBranded, ZodTuple, ZodNullable, ZodPipeline, lazyType } from './index-xQVHYlDO.js';
import { jsxRuntimeExports } from './jsx-runtime-0z1XTyrY.js';
import { createLucideIcon } from './createLucideIcon-54xCjNtQ.js';
import { core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__, Ellipsis, lumeBgLoginPng, discordLogoPng, lumeColorLogoPng, createFormContext as createFormContext$1, isPrefix, formatPaths, getPaths, INTENT, parse, lumeBgRegisterPng, lumeBgPng } from './form-E-Wugsz4.js';
import { Search } from './core_admin__loadShare__react_mf_2_hook_mf_2_form__loadShare__-QC4-TXj-.js';

//#region src/ui/components/index/AuthedIndex.tsx
function AuthedIndex() {
	return /* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare___mf_0_refinedev_mf_1_core__loadShare__.Authenticated, {
		loading: /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: "Checking Login Status" }),
		v3LegacyAuthProviderCompatible: true,
		children: /* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare__react_mf_2_router__loadShare__.Navigate, {
			replace: true,
			to: "/dashboard"
		})
	}, "index");
}
var AuthedIndex_default = core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.withTheme(AuthedIndex);

//#region src/ui/components/login/LoginForm.schema.ts
const LoginSchema = z.object({
	email: z.string().email(),
	password: z.string(),
	remember: z.boolean().optional()
});
var LoginForm_schema_default = LoginSchema;

//#region src/ui/components/login/LoginForm.tsx
const LoginForm = () => {
	const { mutate: login } = core_admin__loadShare___mf_0_refinedev_mf_1_core__loadShare__.useLogin();
	const parsed = core_admin__loadShare___mf_0_refinedev_mf_1_core__loadShare__.useParsed();
	const resetPasswordUrl = core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.useResetPasswordUrl();
	const formConfig = {
		adapter: "rhf",
		validationSchema: LoginForm_schema_default,
		fields: [
			{
				name: "email",
				type: core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.FormFieldType.TEXT,
				label: "Email",
			...
			{
				name: "password",
				type: core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.FormFieldType.PASSWORD,
				label: "Password",
				inputClassName: "mt-4 bg-input border placeholder-input-placeholder",
				labelClassName: "font-semibold text-sm text-secondary-foreground",
				required: true
			...
			{
				name: "remember",
				type: core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.FormFieldType.CHECKBOX,
				label: "Remember Me",
				itemClassName: "flex items-center space-x-2 text-foreground"
			}
		],
		footer: [{
			type: core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.ActionItemType.CUSTOM_COMPONENT,
			component: () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full min-h-[32px] px-4 pb-3 pt-1" }),
			props: {}
		}, {
			type: core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.ActionItemType.SUBMIT,
			label: "Login",
	...
	return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.SchemaForm, { config: formConfig }), /* @__PURE__ */ jsxRuntimeExports.jsxs("p", {
			className: "inline-block mt-4 text-input-placeholder",
			children: [
				"Forgot your password?",
				" ",
				/* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare__react_mf_2_router__loadShare__.Link, {
...
const Chrome = createLucideIcon("chrome", __iconNode$d);
...
const Gitlab = createLucideIcon("gitlab", __iconNode$8);
...
function SocialLogin() {
	const socialLoginProvidersList = core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.usePluginMeta("dashboard", "social_providers") || Array.from(SocialProviders_default.keys());
	const accountSubdomain = core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.useAccountSubdomain();
	const parsed = core_admin__loadShare___mf_0_refinedev_mf_1_core__loadShare__.useParsed();
	const [searchTerm, setSearchTerm] = core_admin__loadShare__react__loadShare__.useState("");
	const [isExtraOpen, setIsExtraOpen] = core_admin__loadShare__react__loadShare__.useState(false);
	...
	return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
		...
		children: [visibleProviders.map(({ bgColor, icon: Icon, key, name }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__.Button, {
		...
		}, key)), remainingProviders.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__.Sheet, {
			onOpenChange: setIsExtraOpen,
			open: isExtraOpen,
			children: [/* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__.SheetTrigger, {
				asChild: true,
				children: /* @__PURE__ */ jsxRuntimeExports.jsxs(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__.Button, {
			...
			}), /* @__PURE__ */ jsxRuntimeExports.jsxs(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__.SheetContent, { children: [
				/* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__.SheetHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__.SheetTitle, { children: "More login options" }) }),
				/* @__PURE__ */ jsxRuntimeExports.jsx("div", {
					className: "py-4",
					children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
						className: "relative",
						children: [/* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "absolute left-2 top-3 h-4 w-4 text-gray-500" }), /* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.Input, {
							className: "pl-8",
				...
				/* @__PURE__ */ jsxRuntimeExports.jsx("div", {
					className: "space-y-2",
					children: filteredOptions.map(({ bgColor, icon: Icon, key, name }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__.Button, {
...
function LoginIndex() {
	const socialLoginEnabled = core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.useFeatureFlag("social_login");
	const registerUrl = core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.useRegisterUrl();
		...
		children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxRuntimeExports.jsx("header", {
					...
					children: /* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.LumeLogo, {})
				}),
				/* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxRuntimeExports.jsx("img", {
						...
						}), /* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.InlineAuthLinkBanner, {
							label: "New user?",
				...
				socialLoginEnabled && /* @__PURE__ */ jsxRuntimeExports.jsx(SocialLogin, {}),
				/* @__PURE__ */ jsxRuntimeExports.jsx("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxRuntimeExports.jsx("footer", {
								...
								children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", {
									...
									children: [/* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare__react_mf_2_router__loadShare__.Link, {
									...
									}) }), /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare__react_mf_2_router__loadShare__.Link, {
...
var LoginIndex_default = core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.withTheme(LoginIndex);

//#region src/ui/components/register/schema.ts
const RegisterSchema = z.object({
	...
	termsOfService: z.boolean({ required_error: "You must agree to the terms of service" })
...
function useFormState(form, subjectRef) {
  var subscribe = core_admin__loadShare__react__loadShare__.useCallback(callback => form.subscribe(callback, () => subjectRef === null || subjectRef === void 0 ? void 0 : subjectRef.current), [form, subjectRef]);
  return core_admin__loadShare__react__loadShare__.useSyncExternalStore(subscribe, form.getState, form.getState);
}
function useSubjectRef() {
  var initialSubject = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var subjectRef = core_admin__loadShare__react__loadShare__.useRef(initialSubject);
...
function createFormContext(options) {
  ...
  var context = createFormContext$1(options);
 ...
 */
var useSafeLayoutEffect = typeof document === 'undefined' ? core_admin__loadShare__react__loadShare__.useEffect : core_admin__loadShare__react__loadShare__.useLayoutEffect;
function useFormId(preferredId) {
  var id = core_admin__loadShare__react__loadShare__.useId();
...
function useNoValidate() {
  ...
  var [noValidate, setNoValidate] = core_admin__loadShare__react__loadShare__.useState(defaultNoValidate);
  useSafeLayoutEffect(() => {
...
function useForm(options) {
  ...
  var [context] = core_admin__loadShare__react__loadShare__.useState(() => createFormContext(_objectSpread2$1(_objectSpread2$1({}, formConfig), {}, {
    formId
  })));
  useSafeLayoutEffect(() => {
...
function enableTypeCoercion(type, options) {
  ...
  if (coercion) {
    schema = anyType().transform(coercion).pipe(type);
  } else if (def.typeName === 'ZodArray') {
    ...
    schema = anyType().transform(options.stripEmptyValue).pipe(new ZodOptional(_objectSpread2(_objectSpread2({}, def), {}, {
      innerType: enableTypeCoercion(def.innerType, options)
    })));
  } else if (def.typeName === 'ZodDefault') {
    var defaultValue = def.defaultValue();
    schema = anyType().transform(options.stripEmptyValue)
    ...
    schema = lazyType(() => enableTypeCoercion(inner, options));
  }
  if (type !== schema) {
...
function coerceFormValue(type, options) {
  ...
  var defaultCoercion = {
    string: compose(stripEmptyString, getCoercion()),
    file: compose(stripEmptyFile, getCoercion()),
    number: compose(stripEmptyString, getCoercion(), getCoercion('number', coerceNumber)),
    boolean: compose(stripEmptyString, getCoercion(), getCoercion('boolean', coerceBoolean)),
    date: compose(stripEmptyString, getCoercion(), getCoercion('date', coerceDate)),
    bigint: compose(stripEmptyString, getCoercion(), getCoercion('bigint', coerceBigInt))
  };
  return enableTypeCoercion(type, {
    cache: new Map(),
    stripEmptyValue: compose(defaultCoercion.string, defaultCoercion.file),
    coerce: type => {
      var _options$customize;
      var coercion = (_options$customize = void 0 ) !== null && _options$customize !== void 0 ? _options$customize : null;
      if (coercion === null) {
...
function RegisterIndex() {
	const register = core_admin__loadShare___mf_0_refinedev_mf_1_core__loadShare__.useRegister();
					...
					/* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.Field, {
									className: "flex-1",
									errors: fields.firstName.errors,
									inputProps: { name: fields.firstName.name },
									labelProps: { children: "First Name" }
								}), /* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.Field, {
									className: "flex-1",
							...
							/* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.FieldCheckbox, {
								errors: fields.termsOfService.errors,
								inputProps: {
									form: form.id,
									name: fields.termsOfService.name
								},
								labelProps: { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", {
									className: "text-sm",
									children: [
										"I agree to the",
										/* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare__react_mf_2_router__loadShare__.Link, {
							...
							/* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__.Button, {
...
core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.withTheme(RegisterIndex);

//#region src/ui/components/reset-password/ResetPasswordConfirmForm.schema.ts
z.object({
	...
	return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxRuntimeExports.jsx("div", {
				...
				children: /* @__PURE__ */ jsxRuntimeExports.jsx(core_admin__loadShare__react_mf_2_router__loadShare__.Outlet, {})
			}),
			/* @__PURE__ */ jsxRuntimeExports.jsx("div", {
...
core_admin__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.withTheme(ResetPasswordLayout);

//#region src/ui/components/reset-password/ResetPasswordForm.schema.ts
z.object({ email: z.string().email("Invalid email address") });

export { AuthedIndex_default, LoginIndex_default };
