import { index_cjs } from './core_abuse__mf_v__runtimeInit__mf_v__-BhTJRpXJ.js';
import { React, core_abuse__loadShare__react__loadShare__ } from './core_abuse__loadShare__react__loadShare__-BrHXNZXB.js';
import { federationRuntime } from './virtual_mf-REMOTE_ENTRY_ID-kwaBKqrT.js';
import { core_abuse__loadShare__react_mf_2_dom__loadShare__ } from './core_abuse__loadShare__react_mf_2_dom__loadShare__-CgnY3flI.js';
...
const ErrorBoundaryContext$1 = core_abuse__loadShare__react__loadShare__.createContext(null);
const initialState$1 = {
  didCatch: false,
  error: null
};
let ErrorBoundary$1 = class ErrorBoundary extends core_abuse__loadShare__react__loadShare__.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (didCatch) {
      ...
      if (typeof fallbackRender === "function") {
        ...
        childToRender = core_abuse__loadShare__react__loadShare__.createElement(FallbackComponent, props);
    ...
    return core_abuse__loadShare__react__loadShare__.createElement(ErrorBoundaryContext$1.Provider, {
      value: {
        didCatch,
        error,
        resetErrorBoundary: this.resetErrorBoundary
...
function createBaseBridgeComponent({
  ...
  return () => {
    ...
    const RawComponent = (info) => {
      ...
      return /* @__PURE__ */ core_abuse__loadShare__react__loadShare__.createElement(RouterContext.Provider, { value: { moduleName, basename, memoryRoute } }, /* @__PURE__ */ core_abuse__loadShare__react__loadShare__.createElement(
    ...
    return {
      async render(info) {
        ...
        const rootComponentWithErrorBoundary = /* @__PURE__ */ core_abuse__loadShare__react__loadShare__.createElement(
          ErrorBoundary$1,
          {
...
function useHref(to, { relative } = {}) {
  ...
  let { basename, navigator: navigator2 } = core_abuse__loadShare__react__loadShare__.useContext(NavigationContext);
...
core_abuse__loadShare__react__loadShare__.createContext(null);
...
function useRoutesImpl(routes, locationArg, dataRouterState, future) {
  ...
  let { navigator: navigator2, static: isStatic } = core_abuse__loadShare__react__loadShare__.useContext(NavigationContext);
...
var defaultErrorElement = /* @__PURE__ */ core_abuse__loadShare__react__loadShare__.createElement(DefaultErrorComponent$1, null);
...
function RouterProvider({
  ...
  let navigator2 = core_abuse__loadShare__react__loadShare__.useMemo(() => {
    return {
...
var FrameworkContext$1 = core_abuse__loadShare__react__loadShare__.createContext(void 0);
FrameworkContext$1.displayName = "FrameworkContext";
function useFrameworkContext() {
  let context = core_abuse__loadShare__react__loadShare__.useContext(FrameworkContext$1);
  invariant2(
    context,
...
function usePrefetchBehavior(prefetch, theirElementProps) {
  let frameworkContext = core_abuse__loadShare__react__loadShare__.useContext(FrameworkContext$1);
...
var NavLink = core_abuse__loadShare__react__loadShare__.forwardRef(
  function NavLinkWithRef({
    ...
    let { navigator: navigator2, basename } = core_abuse__loadShare__react__loadShare__.useContext(NavigationContext);
...
function RouterProvider2(props) {
  return /* @__PURE__ */ core_abuse__loadShare__react__loadShare__.createElement(RouterProvider, { flushSync: core_abuse__loadShare__react_mf_2_dom__loadShare__.flushSync, ...props });
}
var ssrInfo = null;
var router = null;
...
function HydratedRouter(props) {
  ...
  let [criticalCss, setCriticalCss] = core_abuse__loadShare__react__loadShare__.useState(
  ...
  let [location, setLocation] = core_abuse__loadShare__react__loadShare__.useState(router.state.location);
  ...
  return (
    ...
    /* @__PURE__ */ core_abuse__loadShare__react__loadShare__.createElement(core_abuse__loadShare__react__loadShare__.Fragment, null, /* @__PURE__ */ core_abuse__loadShare__react__loadShare__.createElement(
      ...
      /* @__PURE__ */ core_abuse__loadShare__react__loadShare__.createElement(RemixErrorBoundary, { location }, /* @__PURE__ */ core_abuse__loadShare__react__loadShare__.createElement(RouterProvider2, { router }))
    ), /* @__PURE__ */ core_abuse__loadShare__react__loadShare__.createElement(core_abuse__loadShare__react__loadShare__.Fragment, null))
  );
}
...
}, [core_abuse__loadShare__react_mf_2_router__loadShare__]);

function e() {
  const t = new PopStateEvent("popstate", { state: window.history.state });
  window.dispatchEvent(t);
}
const RemoteAppWrapper = core_abuse__loadShare__react__loadShare__.forwardRef(function(props, ref) {
  const {
    moduleName,
    memoryRoute,
    basename,
  ...
  const instance = federationRuntime.instance;
  const rootRef = ref && "current" in ref ? ref : core_abuse__loadShare__react__loadShare__.useRef(null);
  const renderDom = core_abuse__loadShare__react__loadShare__.useRef(null);
  const providerInfoRef = core_abuse__loadShare__react__loadShare__.useRef(null);
  const [initialized, setInitialized] = core_abuse__loadShare__react__loadShare__.useState(false);
...
function withRouterData(WrappedComponent) {
  const Component = core_abuse__loadShare__react__loadShare__.forwardRef(function(props, ref) {
    var _a;
    ...
    try {
      core_abuse__loadShare__react_mf_2_router__loadShare__.useLocation();
    ...
    if (!props.basename && enableDispathPopstate) {
      ...
      if (UNSAFE_RouteContext) {
        ...
        routerContextVal = core_abuse__loadShare__react__loadShare__.useContext(UNSAFE_RouteContext);
    ...
    if (enableDispathPopstate) {
      const location = core_abuse__loadShare__react_mf_2_router__loadShare__.useLocation();
      const [pathname, setPathname] = core_abuse__loadShare__react__loadShare__.useState(location.pathname);
      core_abuse__loadShare__react__loadShare__.useEffect(() => {
  ...
  return core_abuse__loadShare__react__loadShare__.forwardRef(function(props, ref) {
  ...
  return React.lazy(async () => {
    ...
    try {
      ...
      if (exportName in m && typeof exportFn === "function") {
        const RemoteAppComponent = core_abuse__loadShare__react__loadShare__.forwardRef((props, ref) => {
...
function createRemoteComponent$1(info) {
  ...
  return core_abuse__loadShare__react__loadShare__.forwardRef((props, ref) => {
    return /* @__PURE__ */ React.createElement(
      ErrorBoundary$1,
      {
...
const ErrorBoundaryContext = core_abuse__loadShare__react__loadShare__.createContext(null);

const initialState = {
  didCatch: false,
  error: null
};
class ErrorBoundary extends core_abuse__loadShare__react__loadShare__.Component {
  constructor(props) {
    super(props);
    this.resetErrorBoundary = this.resetErrorBoundary.bind(this);
  ...
  render() {
    ...
    return core_abuse__loadShare__react__loadShare__.createElement(ErrorBoundaryContext.Provider, {
      value: {
        didCatch,
        error,
        resetErrorBoundary: this.resetErrorBoundary
...
function RouteErrorBoundary({ children }) {
  ...
  try {
    ...
    const potentialRouterError = core_abuse__loadShare__react_mf_2_router__loadShare__.useRouteError();
...
const DummyContext = core_abuse__loadShare__react__loadShare__.createContext(void 0);
function ContextBridgeProvider({
  ...
  const value = core_abuse__loadShare__react__loadShare__.useContext(context || DummyContext);
  core_abuse__loadShare__react__loadShare__.useEffect(() => {
    if (context) {
...
function RemoteContextConsumer({
  ...
  const [value, setValue] = core_abuse__loadShare__react__loadShare__.useState(() => {
...
const FrameworkContext = core_abuse__loadShare__react__loadShare__.createContext(
  null
);
...
function FrameworkProvider({
  ...
  const builderRef = core_abuse__loadShare__react__loadShare__.useRef();
  const frameworkRef = core_abuse__loadShare__react__loadShare__.useRef();
  const [state, setState] = core_abuse__loadShare__react__loadShare__.useState({
    error: null,
    framework: null,
    isLoading: true
  });
  const initializeFrameworkInstance = core_abuse__loadShare__react__loadShare__.useCallback(async () => {
    try {
...
function useFramework() {
  const context = core_abuse__loadShare__react__loadShare__.useContext(FrameworkContext);
  if (!context) {
...
var m = core_abuse__loadShare__react_mf_2_dom__loadShare__;
...
function createBridgeComponent(Component) {
  const WrappedComponent = core_abuse__loadShare__react__loadShare__.forwardRef(
    (props, ref) => {
...
function WidgetArea({ widgetAreaId }) {
  ...
  const [widgets, setWidgets] = core_abuse__loadShare__react__loadShare__.useState([]);
  core_abuse__loadShare__react__loadShare__.useEffect(() => {
    if (!framework) {
      return;
    }
    ...
    const renderableWidgets = loadedWidgets.map((widget) => {
      if (typeof widget === "function" && "then" in widget && typeof widget.then === "function") {
        const BridgeWrapper = () => {
          const [isLoading, setIsLoading] = core_abuse__loadShare__react__loadShare__.useState(true);
          core_abuse__loadShare__react__loadShare__.useEffect(() => {
