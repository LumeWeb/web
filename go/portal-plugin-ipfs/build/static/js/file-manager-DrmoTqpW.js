import { createLucideIcon, core_ipfs__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_core__loadShare__, core_ipfs__loadShare__react__loadShare__, jsxRuntimeExports, Folder, CID } from './folder-BEVrBiCO.js';
...
// dev uses dynamic import to separate chunks
    ...
    const res$3 = initPromise$3.then(_ => loadShare$3("@refinedev/core", {
    ...
    var core_ipfs__loadShare___mf_0_refinedev_mf_1_core__loadShare__ = exportModule$3;

// dev uses dynamic import to separate chunks
    
    const {loadShare: loadShare$2} = index_cjs;
    const {initPromise: initPromise$2} = core_ipfs__mf_v__runtimeInit__mf_v__;
    const res$2 = initPromise$2.then(_ => loadShare$2("@lumeweb/portal-framework-ui", {
    customShareInfo: {shareConfig:{
      singleton: true,
      strictVersion: false,
    ...
    var core_ipfs__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__ = exportModule$2;

// dev uses dynamic import to separate chunks
    
    const {loadShare: loadShare$1} = index_cjs;
    const {initPromise: initPromise$1} = core_ipfs__mf_v__runtimeInit__mf_v__;
    const res$1 = initPromise$1.then(_ => loadShare$1("react-router", {
    customShareInfo: {shareConfig:{
      singleton: true,
      strictVersion: false,
...
// dev uses dynamic import to separate chunks
    ...
    var core_ipfs__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui_mf_2_core__loadShare__ = exportModule;
...
const CidInputComponent = core_ipfs__loadShare__react__loadShare__.forwardRef(({ existingPinnedCids = [] }, ref) => {
  ...
  const stats = {
    ...
    newToPin: cidTags.filter((tag) => tag.isValid && !tag.isAlreadyPinned).length
  };
...
function createUnpinDialogConfig(cid, onUnpin, open) {
  return {
    ...
    size: core_ipfs__loadShare___mf_0_lumeweb_mf_1_portal_mf_2_framework_mf_2_ui__loadShare__.ComponentSize.DEFAULT
  };
}
      ...
      cell: ({ row }) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              item.is_directory ? /* @__PURE__ */ jsxRuntimeExports.jsx(Folder, { className: "text-primary h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(File, { className: "text-primary h-4 w-4" }),
