...
import { r as reactExports, j as jsxRuntimeExports, g as getDefaultExportFromCjs, h as commonjsGlobal, R as React } from "./index-C3JligFb.js";
import { j as createLucideIcon, c as createContextScope, P as Primitive, d as useCallbackRef, f as useLayoutEffect2, B as Button, h as cn, C as Cross2Icon, K as baseStore, L as createStore, M as useStore, i as cva, u as useComposedRefs, e as composeEventHandlers, N as hideOthers, S as Slot, O as FocusScope, Q as useId, a as useControllableState, R as CaretSortIcon, T as ChevronUpIcon, U as ChevronDownIcon, V as CheckIcon, b as Presence, W as Slottable, X as TrashIcon, k as useBaseStore, Y as composeRefs, g as dispatchDiscreteCustomEvent, I as ChevronRightIcon, _ as DotFilledIcon, $ as ExitIcon } from "./createLucideIcon-BCL4v026.js";
import { n as $e, o as oo, u as useMutation, p as Lr } from "./index-C2KIIWov.js";
import { f as CloudUploadIcon, c as createCollection, g as createPopperScope, h as Anchor, i as useFocusGuards, j as ReactRemoveScroll, D as DismissableLayer, k as Content$1, l as Arrow, V as VisuallyHidden, P as Portal$3, m as Root2$2, n as Root$5, o as BoxCheckedIcon, E as ExclamationCircleIcon, p as PageIcon, u as useSdk, q as CloudSelectIcon, r as ChevronDownIcon$1, H as HamburgerMenuIcon, T as ThemeSwitcher } from "./useTheme-BwPuTtGa.js";
import { O as Overlay, C as Content, a as Close, T as Title, D as Description, R as Root$3, P as Portal$2, j as Root$4, k as usePrevious, E as ErrorList, u as useFeatureFlag, L as LumeLogo, S as Sheet, e as SheetTrigger, f as SheetContent, g as SheetHeader, m as SheetDescription, i as discordLogoPng, l as lumeColorLogoPng } from "./useFeatureFlag-DaT8CAZ9.js";
import { r as reactDomExports, l as useSearchParams, L as Link, m as useMatches } from "./components-Dv2u7XfC.js";
/**
 ...
 */
function interpolate$1(phrase, options) {
  const dollarRegex = /\$/g;
  ...
  translateArray(key, options) {
    ...
    if (hasPluralForms) {
      if (options && typeof options.smart_count !== "undefined") {
        ...
        return interpolate$1(string[plural], options);
      }
    ...
    return interpolate$1(string, options);
  }
}
...
var isObject$1 = isObject_1, now$1 = now_1, toNumber = toNumber_1;
...
var wildcard$1 = function(text, test2, separator) {
...
class Uppy {
  ...
  getObjectOfFilesPerState() {
    ...
    for (const file of files) {
      ...
      if (!progress2.uploadComplete && progress2.uploadStarted) {
        inProgressFiles.push(file);
        if (!file.isPaused) {
          inProgressNotPausedFiles.push(file);
        }
      }
      if (!progress2.uploadStarted) {
        newFiles.push(file);
      }
      if (progress2.uploadStarted || progress2.preprocess || progress2.postprocess) {
      ...
      if (progress2.uploadComplete) {
        completeFiles.push(file);
      }
      if (file.error) {
        erroredFiles.push(file);
      }
      if (progress2.preprocess || progress2.postprocess) {
...
function _addListeners2() {
  ...
  this.on("preprocess-progress", (file, progress2) => {
    if (file == null || !this.getFile(file.id)) {
      this.log(`Not setting progress for a file that has been removed: ${file == null ? void 0 : file.id}`);
      return;
    }
  ...
  this.on("postprocess-progress", (file, progress2) => {
    if (file == null || !this.getFile(file.id)) {
      this.log(`Not setting progress for a file that has been removed: ${file == null ? void 0 : file.id}`);
      return;
    }
...
function UploadForm() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { htmlFor: "service-select", className: "block mb-2", children: "Select Service" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Select,
        {
...
const NavItem = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(NavigationItem, { active, href: item.path, children: [
    ...
    (_b = (_a = item.children) == null ? void 0 : _a.filter((item2) => {
      ...
      const isActive = child.path ? matches.some((match2) => match2.pathname.startsWith(child.path)) : false;
...
const MainNavigation = () => {
  ...
  const renderMenuItem = (item) => {
    ...
    const isActive = matches.some((match2) => paths.some((path) => match2.pathname.startsWith(path)));
...
function GeneralLayout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GeneralLayout$1, { showUploadForm: false, children });
}
export {
  Dialog as D,
  GeneralLayout as G,
