import { index_cjs, core_abuse_mf_2_report__mf_v__runtimeInit__mf_v__ } from './core_abuse_mf_2_report__mf_v__runtimeInit__mf_v__-BXpB7fOH.js';
import exposesMap from './virtualExposes-C8ugtUvn.js';
...
const importMap = {
        ...
        "@lumeweb/portal-framework-core": async () => {
          let pkg = await import('./index-ClLvRL03.js');
          return pkg
        }
      ,
        "@lumeweb/portal-framework-ui": async () => {
          let pkg = await import('./index-BXnTWA9y.js');
          return pkg
        }
      ,
        "@lumeweb/portal-framework-ui-core": async () => {
          let pkg = await import('./index-DATKLiqv.js');
          return pkg
        }
      ,
        "@refinedev/core": async () => {
          let pkg = await import('./index-Zw0nTCpg.js');
          return pkg
        }
      ,
        "react": async () => {
      ...
      ,
        "react-router": async () => {
          let pkg = await import('./index-mXCgtSNj.js');
          return pkg
        }
      ,
        "@tanstack/react-query": async () => {
          let pkg = await import('./index-CoyW--qm.js');
          return pkg
        }
      ,
        "react-hook-form": async () => {
          let pkg = await import('./index.esm-Bx3VT4Kt.js');
          return pkg
        }
      ,
        "react-dom": async () => {
          let pkg = await import('./index-LZXfrCzj.js').then(n => n.index);
          return pkg
        }
...
const initTokens = {};
  ...
  const mfName = "core:abuse-report";
  async function init(shared = {}, initScope = []) {
    ...
    core_abuse_mf_2_report__mf_v__runtimeInit__mf_v__.initResolve(initRes);
    return initRes
  }
