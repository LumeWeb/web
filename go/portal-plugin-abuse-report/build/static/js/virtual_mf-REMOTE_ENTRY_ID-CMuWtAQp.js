...
import exposesMap from './virtualExposes-BKRZw-uy.js';
...
const importMap = {
        ...
        "@lumeweb/portal-framework-core": async () => {
          let pkg = await import('./index-FJPkjhA2.js');
          return pkg
        }
      ,
        "@lumeweb/portal-framework-ui": async () => {
          let pkg = await import('./index--WmR136Q.js');
          return pkg
        }
      ,
        "@refinedev/core": async () => {
          let pkg = await import('./index-CBTbUB53.js');
          return pkg
        }
      ,
        "react": async () => {
