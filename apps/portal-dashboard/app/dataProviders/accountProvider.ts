import type { HttpError, UpdateParams, UpdateResponse } from "@refinedev/core";
import { SdkProvider } from "~/dataProviders/sdk-provider.js";
...
export const accountProvider: SdkProvider = {
  ...
  async update<TVariables extends AccountParams = AccountParams>(
    ...
    if (params.variables.email && params.variables.password) {
      const ret = await accountProvider.sdk
        ?.account()
