...
function renderIndex(doc: CLIDoc, categories: string[], envVars: { name: string; description: string }[]): string {
  ...
  parts.push("---");
  parts.push(`title: "CLI Reference"`);
  parts.push(`description: "Complete reference for the ${cliName} CLI."`);
  parts.push("---");
  parts.push("");
  parts.push("> **This page is auto-generated.** Do not edit directly.");
  parts.push(`> To update, modify the CLI source in [pinner-cli](https://github.com/LumeWeb/pinner-cli) and run \`pnpm generate:cli\`.`);
  parts.push("");
...
function renderCategoryPage(doc: CLIDoc, category: string, cliName: string): string {
  ...
  const parts: string[] = [];
  parts.push("---");
  parts.push(`title: "CLI: ${category}"`);
  parts.push(`description: "${cliName} CLI commands for ${category.toLowerCase()}."`);
  parts.push("---");
  parts.push("");
  parts.push("> **This page is auto-generated.** Do not edit directly.");
  parts.push(`> To update, modify the CLI source in [pinner-cli](https://github.com/LumeWeb/pinner-cli) and run \`pnpm generate:clil\`.`);
  parts.push("");
