...
function autoGeneratedNotice(): string[] {
  return [
    `> **This page is auto-generated** from [TypeDoc](https://typedoc.org/) based on the [${packageName}](https://github.com/LumeWeb/web/tree/develop/libs/pinner/src) source code. Do not edit directly.`,
    "",
  ];
}
...
function renderClassPage(cls: TypeDocChild): string {
  ...
  parts.push(...frontmatter(`SDK: ${className}`, `API reference for the ${className} class in ${packageName}.`));
...
function renderErrorsPage(classes: TypeDocChild[]): string {
  ...
  parts.push(...frontmatter("SDK: Errors", `Error classes thrown by the ${packageName} SDK.`));
...
function renderTypesPage(types: TypeDocChild[]): string {
  ...
  parts.push(...frontmatter("SDK: Types", `Interfaces, type aliases, and enums in ${packageName}.`));
...
function renderIndex(classes: TypeDocChild[], types: TypeDocChild[]): string {
  ...
  parts.push(...frontmatter("SDK Reference", `Complete API reference for the ${packageName} SDK.`));
