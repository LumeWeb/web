...
export function Hero({ backgroundImage, blur = "sm", minHeight = "lg", bgPosition = "center", children }: HeroProps) {
...
export function HomepageHero({ backgroundImage, minHeight, blur, bgPosition, buttons, title, titleSize, emphasis, tagline }: HeroProps & HeroContentProps) {
  return (
    <Hero backgroundImage={backgroundImage} minHeight={minHeight} blur={blur} bgPosition={bgPosition}>
      <HeroContent
        title={title}
        titleSize={titleSize}
