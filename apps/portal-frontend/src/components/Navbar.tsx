...
import PinnerLogo from "@/assets/logo.svg";
...
const menuStates: Record<MenuState, string> = {
	...
	1: "flex justify-between flex-col pb-10 visible",
};
...
const Nav = () => {
  ...
  return (
      ...
      <header className="pt-[58px] pb-[18px] md:py-10 absolute w-full top-0 left-0 z-40">
        <div className="xl:container px-6">
          <div className="flex gap-[30px] justify-between items-center">
            <div className="flex items-center xl:gap-[30px] 2xl:gap-[60px]">
              <div className="relative z-40 min-w-24 flex items-center">
                <a href="/">
                  <img src={PinnerLogo.src} alt="site logo" className="h-10 w-auto" />
                </a>
              </div>
              <nav
                className={cn(
                  menuStates[Number(toggleMenu) as MenuState],
                  "transition-all duration-300 ease-in-out fixed w-full top-0 pt-[130px] lg:pt-0 lg:block left-0 bg-content-text lg:static lg:bg-transparent md:px-0 h-screen lg:h-auto"
                )}>
                <ul className="flex flex-col py-5 px-6 lg:flex-row lg:py-0 space-x-0 lg:space-x-8 container">
                  <li>
                    <a
                      href="/about"
                      className="text-home-text leading-[50px] border-b border-border-dark lg:border-transparent block lg:leading-5 text-[15px] lg:text-lg font-medium transition ease-in-out duration-300 hover:border-b hover:border-home-text">
                      About Pinner
                    </a>
                  </li>
                  ...
                  <li>
                    <a
                      ...
                      className="flex gap-3 items-center text-home-text leading-[50px] border-b border-border-dark lg:border-transparent lg:leading-5 text-[15px] lg:text-lg font-medium transition ease-in-out duration-300">
                      <svg
                        height="20px"
                        width="20px"
                        version="1.1"
	...
	C512,137.911,498.388,101.305,474.655,74.503z"
                        />
                        <path
                          style={{ fill: "var(--color-orange-dark)" }}
	...
	c2.203,0.988,4.779,0.988,6.981,0c0.689-0.308,5.586-2.524,13.577-6.588C251.254,463.709,206.371,438.825,160.959,401.243z"
                ...
                <div className="lg:hidden container">
                  <div className="flex gap-8">
                    ...
                    <ul className="flex gap-11">
                      <li>
                        <a
                          href="#"
                          className="text-home-text text-base leading-[34px] transition ease-in-out duration-300 flex items-center gap-2 hover:text-white">
                          <svg
                  ...
                  <a
                    ...
                    className="basis-full flex-1 md:inline-block underline mb-4  text-home-text text-base leading-[34px] transition ease-in-out duration-300 hover:text-white order-2 md:order-1">
                    hello@lumeweb.com
                  </a>
                </div>
              </nav>
            ...
            <div className="flex items-center space-x-5 hidden lg:flex">
              <a
                ...
                target="_blank"
                className="text-home-text font-medium text-lg transition ease-in-out duration-300 hover:text-gray-hover">
                Sign In
              </a>
              <Button
                label="Start Storing → "
