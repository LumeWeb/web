...
const StorageCard = () => {
  return (
    <div className="bg-[#0D2D2A] p-6 lg:p-[45px] max-w-[640px] mx-auto rounded-xl">
      <div className="flex justify-between items-center mb-11">
        <div>
          <div className="flex items-center space-x-2 mb-1.5">
            ...
            <p className="text-[#ADF0DD] text-[18px] md:text-[21px] font-semibold mb-0">
              Storage
            </p>
          </div>
          <p className="text-[#75AC9E] text-[12px] md:text-[14px] font-medium tracking-[0.28px]">
        ...
        <a
          href="#"
          className="lg:bg-[#051413] text-[#ADF0DD] inline-flex text-[11px] md:text-[14px] py-[13px] px-[17px] font-medium tracking-[0.28px] rounded-sm items-center gap-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="18"
            height="18"
      ...
      <div>
        <Progress value={85} />
        <div className="flex justify-between text-[#75AC9E] text-[14px] font-medium tracking-[0.28px] mt-5">
          <p>120 GB Used</p>
          <p>10 GB Left</p>
        </div>
      </div>
