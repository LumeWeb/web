...
export const DownloadProgressCard = ({
  ...
  return (
    <div className="bg-dark-card rounded-lg p-[20px] md:p-[40px] flex flex-col shadow-md border border-transparent md:border-home-card-bg w-full max-w-full lg:max-w-[549px] lg:h-[216px]">
      <div className="flex justify-between items-center">
        ...
        <button className="md:bg-home-card-bg text-[12px] md:text-[14px] text-white rounded px-3 py-1 flex items-center gap-1 hover:bg-teal-600">
          <span>+</span> Add More
        </button>
      </div>
      <div className="mt-6 md:mt-10">
        <div className="w-full bg-gray-600 rounded-full h-2 md:h-4">
          <div
            className="bg-teal-accent h-2 md:h-4 rounded-full"
