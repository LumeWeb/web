...
- [What You're Agreeing To — Quick Summary](#what-youre-agreeing-to--quick-summary)
- [1. Acceptance of Terms](#1-acceptance-of-terms)
- [2. About Our Service](#2-about-our-service)
- [3. Who Can Use Our Service](#3-who-can-use-our-service)
- [4. What You Can and Can't Do](#4-what-you-can-and-cant-do)
- [5. Your Content](#5-your-content)
- [6. Our Intellectual Property](#6-our-intellectual-property)
- [7. Subscription, Billing & Payments](#7-subscription-billing--payments)
- [8. Service Availability](#8-service-availability)
- [9. Data When You Cancel](#9-data-when-you-cancel)
- [10. Termination](#10-termination)
- [11. Your Responsibility](#11-your-responsibility)
...
- **Disputes go to North Carolina courts.** No forced arbitration, no class action waivers.
...
We respect intellectual property rights and comply with the Digital Millennium Copyright Act (DMCA). We have designated a DMCA agent to receive copyright infringement notices:

- **Email:** dmca@pinner.xyz

**Takedown notices.** If you believe content on our service infringes your copyright, send a written notice to our DMCA agent. Your notice must include:

1. A physical or electronic signature of the copyright owner or authorized representative.
2. Identification of the copyrighted work you believe is being infringed.
3. Identification of the specific content on our service that you claim is infringing — include the content identifier (CID for IPFS pins, or the share URL for shared Sia objects). A share URL contains the decryption key that makes the content accessible; an object ID alone does not allow us to see what the file contains. If you do not have the share URL, provide whatever identifying information you have and we will take action where possible.
4. Your contact information (name, address, telephone number, and email).
5. A statement that you believe in good faith that the use of the content is not authorized by the copyright owner, its agent, or the law.
...
**Counter-notices.** If you believe your content was removed or disabled as a result of a mistake or misidentification, you may send a written counter-notice to our DMCA agent. Your counter-notice must include:
...
4. Your name, address, telephone number, and a statement consenting to the jurisdiction of the federal court in the district where you reside (or the district where Pinner's service is located, if outside the United States), and that you will accept service of process from the person who filed the original notice or their agent.

We will restore removed content within 10–14 business days of receiving a valid counter-notice, unless the original complainant files a court action against you.
...
Our pricing is based on storage used, billed per terabyte (TB). Current pricing is available at [pinner.xyz/pricing](https://pinner.xyz/pricing). You choose monthly or annual billing.
...
If we can't reach you or the issue remains unresolved after that window, we may suspend your account. Suspended accounts retain their data for 30 days. After 30 days of suspension, we may terminate the account and delete associated data.
...
**No Forced Arbitration, No Class Action Waiver:** We do not require arbitration. We do not waive class action rights. Disputes will be resolved in court as described in Section 14.

---

## 14. Dispute Resolution

**In plain English:** If you have a problem, email us first. We'll try to work it out. If we can't, disputes go to courts in North Carolina.

### Informal Resolution First

Before filing a legal claim, contact us at legal@pinner.xyz and give us a reasonable opportunity (at least 30 days) to resolve the dispute informally. Most issues can be resolved this way.

### Litigation

If informal resolution fails, any dispute arising out of or relating to these Terms or the Service will be resolved exclusively in the state or federal courts located in North Carolina, USA. You consent to the personal jurisdiction and venue of these courts.

**We do not require arbitration.** We do not waive class action rights. You retain all rights available to you under applicable law.
...
- [Report Content](mailto:abuse@pinner.xyz)
