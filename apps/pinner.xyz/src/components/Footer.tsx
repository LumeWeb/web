		...
		<footer className={t.bg}>
			<div className="container py-8">
				<div className="flex flex-col items-center gap-6">
					...
					<div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-2 md:gap-x-5">
						<a
							href="https://docs.pinner.xyz"
							target="_blank"
							rel="noopener noreferrer"
							className={cn(t.link, "text-sm md:text-base transition ease-in-out duration-300")}>
							Documentation
						</a>
						<a
						...
						<span className={cn(t.separator, "hidden md:inline")}>|</span>
						<a
						...
						<a
							href="/alternatives/netlify"
							className={cn(t.link, "text-sm md:text-base transition ease-in-out duration-300")}>
							Netlify Alternative
						</a>
						<a
							href="/alternatives/pinata"
							className={cn(t.link, "text-sm md:text-base transition ease-in-out duration-300")}>
							Pinata Alternative
						</a>
						<a
							href="/alternatives/fleek"
							className={cn(t.link, "text-sm md:text-base transition ease-in-out duration-300")}>
							Fleek Alternative
						</a>
						<span className={cn(t.separator, "hidden md:inline")}>|</span>
