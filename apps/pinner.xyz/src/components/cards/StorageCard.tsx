...
const StorageCard = () => {
  return (
    <div className="bg-home-card-bg p-6 lg:p-[45px] max-w-[640px] mx-auto rounded-xl">
      <div className="flex justify-between items-center mb-11">
        <div>
          <div className="flex items-center space-x-2 mb-1.5">
            ...
            <p className="text-teal-accent text-[18px] md:text-[21px] font-semibold mb-0">
              Storage
            </p>
          </div>
          <p className="text-teal-muted text-[12px] md:text-[14px] font-medium tracking-[0.28px]">
        ...
        <button
          type="button"
          disabled
          className="lg:bg-home-section-dark text-teal-accent inline-flex text-[11px] md:text-[14px] py-[13px] px-[17px] font-medium tracking-[0.28px] rounded-sm items-center gap-2 cursor-not-allowed opacity-60">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="18"
            height="18"
      ...
      <div>
        <Progress value={85} />
        <div className="flex justify-between text-teal-muted text-[14px] font-medium tracking-[0.28px] mt-5">
          <p>120 GB Used</p>
          <p>10 GB Left</p>
        </div>
      </div>
