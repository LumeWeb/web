...
export const SecurityCard = ({ title, star, description, buttonText, background }: SecurityCardProps) => {
  return (
    <div
      className={cn(
        background || "bg-dark-card",
        "text-teal-100 rounded-lg p-6 lg:p-10 shadow-md flex flex-col justify-between space-y-4 w-full md:w-auto"
      )}>
      {/* Icon and Title */}
      <div>
          ...
          <svg
            ...
            <g clip-path="url(#clip0_306_3708)">
              <path
                ...
                fill="var(--color-teal-accent, #ADF0DD)"
              />
            </g>
            <defs>
      ...
      {/* Action Button */}
      <div className="bg-[var(--home-card-bg, #0D2D2A)] hover:bg-teal-900 text-sm px-4 py-2 rounded-lg text-white flex items-center justify-center space-x-2">
        <svg
          width="18"
          height="19"
          viewBox="0 0 18 19"
