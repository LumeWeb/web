                 ...
                 <ul className="flex flex-col py-5 px-6 lg:flex-row lg:py-0 space-x-0 lg:space-x-6 xl:space-x-8 container">
                              ...
                              {solutions.map((item) => (
                                <li key={item.href}>
                                  <NavigationMenuLink
                                    href={item.href}
                                    className={cn(
                                      "block select-none rounded-md px-3 py-2 text-sm no-underline transition-colors",
                                      textColor,
                  ...
                  <li>
                    <a
                      ...
                      className={cn(
                        "flex gap-3 items-center leading-[50px] border-b whitespace-nowrap",
                        borderColor,
                      ...
                      <svg
                        ...
                        version="1.1"
                        viewBox="0 0 512 512"
                        className="md:block hidden shrink-0">
                        <path
