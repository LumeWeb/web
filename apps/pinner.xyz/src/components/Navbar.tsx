...
import FooterLogoDark from "@/assets/footer-logo.svg";
...
const Nav = ({ theme = "dark" }: NavProps) => {
  ...
  const footerLogo = isDark ? FooterLogoLight : FooterLogoDark;
            ...
            <div className="flex items-center xl:gap-[30px] 2xl:gap-[60px]">
              <div className="relative z-40 min-w-24 flex items-center">
                <a href="/" aria-label="Pinner home">
                  <img src={SiteLogo.src} alt="site logo" width={160} height={40} className="h-10 w-auto" loading="eager" fetchpriority="high" />
                </a>
              </div>
              <nav
                className={cn(
                  ...
                  bgColor,
                  "lg:static lg:bg-transparent md:px-0 h-screen lg:h-auto"
                )}>
                <ul className="flex flex-col py-5 px-6 lg:flex-row lg:py-0 space-x-0 lg:space-x-8 container">
                  ...
                  <li>
                    <a
                      ...
                      className={cn(
                        "flex gap-3 items-center leading-[50px] border-b",
                        borderColor,
	...
	c2.203,0.988,4.779,0.988,6.981,0c0.689-0.308,5.586-2.524,13.577-6.588C251.254,463.709,206.371,438.825,160.959,401.243z"
                ...
                <div className="lg:hidden container">
                  <div className="flex gap-8">
                    <img src={footerLogo.src} alt="footer logo" width={120} height={40} loading="lazy" />
                        ...
                        <a
                          ...
                          <svg
                            ...
                            <path
                              ...
                              fill={isDark ? "var(--color-home-text)" : "var(--color-content-text)"}
                            />
                            <path
                  ...
                  <a
                    href="mailto:hello@pinner.xyz"
                    className={cn(
                      "basis-full flex-1 md:inline-block underline mb-4 text-base leading-[34px] transition ease-in-out duration-300 order-2 md:order-1",
                      textColor,
                      hoverColor
                    )}>
                    hello@pinner.xyz
