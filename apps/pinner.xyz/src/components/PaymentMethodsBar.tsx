  ...
  return (
    <Section variant={variant} padding={compact ? "none" : "sm"}>
      <div className="container px-6">
        ...
        <div className={`flex items-center justify-center gap-3 md:gap-4 ${compact ? "flex-wrap" : "flex-wrap 2xl:flex-nowrap"}`}>
          ...
          <span className={`w-px ${compact ? "h-4" : "h-8"} bg-home-text/20 mx-1 md:mx-2 flex-shrink-0`} aria-hidden="true" />
