...
const Hero = () => {
  ...
  return (
    <HeroSection
      ...
      subheadline={<><a href="/solutions/ipfs-pinning" className="underline hover:text-white transition-colors">IPFS pinning</a>, <a href="/solutions/website-hosting" className="underline hover:text-white transition-colors">website hosting</a>, and private storage &mdash; no one else can read your files.<br/><br/>Not even us.</>}
      primaryButton={{
        label: "Start Pinning →",
      ...
      microcopy="No credit card required · No ID for crypto payments"
