import { j as jsxRuntimeExports, g as getDefaultExportFromCjs, r as reactExports, R as React } from "./jsx-runtime-IZdvEyt_.js";
import { a as ii, m as mc } from "./index-DU1IfKY5.js";
import { u as useIsMobile, G as GeneralLayout } from "./GeneralLayout-DFAD2LNJ.js";
import { c as CurrentUsageIcon, d as CloudIcon, e as CloudDownloadIcon, b as CloudUploadSolidIcon } from "./icons-DfV8n6Ey.js";
import { u as useCurrentUsage, U as UsageCard } from "./useCurrentUsage-CtAD3g0m.js";
import { u as useIsBillingEnabled } from "./avatar-BEvRnn4D.js";
import { S as Skeleton } from "./skeleton-DwNK_yGs.js";
import { u as useSubscription, a as useApiUrl } from "./useSubscription-BJBkiziB.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-AoQj0I9n.js";
import { b as clsx, c as cn } from "./button-CzfLTIHt.js";
import { i as isSymbol_1, _ as _baseGetTag, j as isObject_1, k as _root, l as _Symbol, m as isObjectLike_1, n as isObject$4, o as _freeGlobal, t as throttle, p as toNumber_1, T as TooltipProvider, a as Tooltip$1, b as TooltipTrigger, c as TooltipContent } from "./useTheme-Wun3lQOi.js";
...
var adaptEventsOfChild = function adaptEventsOfChild2(props, data, index) {
  if (!isObject$4(props) || _typeof$E(props) !== "object") {
    return null;
  }
  var out = null;
...
var Legend = /* @__PURE__ */ function(_PureComponent) {
  ...
  function Legend2() {
    ...
    _defineProperty$z(_assertThisInitialized$8(_this), "lastBoundingBox", {
      width: -1,
      height: -1
    });
    return _this;
...
function _iterableToArrayLimit$b(r2, l2) {
  ...
  if (null != t2) {
    var e3, n2, i, u, a2 = [], f2 = true, o = false;
    try {
...
var TooltipBoundingBox = /* @__PURE__ */ function(_PureComponent) {
  ...
  function TooltipBoundingBox2() {
    ...
    _defineProperty$v(_assertThisInitialized$7(_this), "state", {
      dismissed: false,
    ...
    _defineProperty$v(_assertThisInitialized$7(_this), "handleKeyDown", function(event) {
      if (event.key === "Escape") {
...
function ErrorBar(props) {
  var offset = props.offset, layout = props.layout, width = props.width, dataKey = props.dataKey, data = props.data, dataPointFormatter = props.dataPointFormatter, xAxis = props.xAxis, yAxis = props.yAxis, others = _objectWithoutProperties$a(props, _excluded$a);
...
var Brush = /* @__PURE__ */ function(_PureComponent) {
  ...
  function Brush2(props) {
    ...
    _defineProperty$c(_assertThisInitialized$4(_this), "handleDrag", function(e3) {
      if (_this.leaveTimer) {
    ...
    _defineProperty$c(_assertThisInitialized$4(_this), "handleTouchMove", function(e3) {
      if (e3.changedTouches != null && e3.changedTouches.length > 0) {
        _this.handleDrag(e3.changedTouches[0]);
      }
    });
    _defineProperty$c(_assertThisInitialized$4(_this), "handleDragEnd", function() {
      _this.setState({
        isTravellerMoving: false,
        isSlideMoving: false
      }, function() {
    ...
    _defineProperty$c(_assertThisInitialized$4(_this), "handleLeaveWrapper", function() {
      if (_this.state.isTravellerMoving || _this.state.isSlideMoving) {
        _this.leaveTimer = window.setTimeout(_this.handleDragEnd, _this.props.leaveTimeOut);
      }
    });
    _defineProperty$c(_assertThisInitialized$4(_this), "handleEnterSlideOrTraveller", function() {
      _this.setState({
        isTextActive: true
      });
    });
    _defineProperty$c(_assertThisInitialized$4(_this), "handleLeaveSlideOrTraveller", function() {
      _this.setState({
        isTextActive: false
      });
    });
    _defineProperty$c(_assertThisInitialized$4(_this), "handleSlideDragStart", function(e3) {
...
var Bar = /* @__PURE__ */ function(_PureComponent) {
  ...
  function Bar2() {
    ...
    _defineProperty$a(_assertThisInitialized$3(_this), "state", {
      isAnimationFinished: false
    });
    _defineProperty$a(_assertThisInitialized$3(_this), "id", uniqueId("recharts-bar-"));
    _defineProperty$a(_assertThisInitialized$3(_this), "handleAnimationEnd", function() {
    ...
    _defineProperty$a(_assertThisInitialized$3(_this), "handleAnimationStart", function() {
