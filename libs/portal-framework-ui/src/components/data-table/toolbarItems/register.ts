...
function createStandardFilter<TData extends BaseRecord = any>(
  ...
  return {
    ...
    config: {
      ...
      operator,
      placeholder: additionalConfig.placeholder,
      options: additionalConfig.options,
      min: additionalConfig.min,
      max: additionalConfig.max,
      step: additionalConfig.step,
      disabled: additionalConfig.disabled,
      className: additionalConfig.className,
      minPlaceholder: additionalConfig.minPlaceholder,
      maxPlaceholder: additionalConfig.maxPlaceholder,
      dropdownStyle: additionalConfig.dropdownStyle,
      customProps: additionalConfig.customProps,
      ...additionalConfig,
    },
