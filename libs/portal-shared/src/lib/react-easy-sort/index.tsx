...
import {
  useDrag,
  useDropTarget,
} from "libs/portal-shared/src/lib/react-easy-sort/hooks";
import { Point } from "libs/portal-shared/src/lib/react-easy-sort/types";
...
const SortableList = <
  TTag extends keyof JSX.IntrinsicElements = typeof DEFAULT_CONTAINER_TAG,
>({
  children,
  allowDrag = true,
  onSortEnd,
